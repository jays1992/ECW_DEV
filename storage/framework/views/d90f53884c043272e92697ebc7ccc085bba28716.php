            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($objDOCN->SYSTEM_GRSR) && $objDOCN->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="PONO" id="PONO" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                           
                            <?php elseif(isset($objDOCN->MANUAL_SR) && $objDOCN->MANUAL_SR == "1"): ?>
                                <input type="text" name="PONO" id="PONO" value="<?php echo e(old('PONO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objDOCN->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase"  >
                            <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(old('PODT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Purchase\PurchaseOrder\trnfrm63add.blade.php ENDPATH**/ ?>