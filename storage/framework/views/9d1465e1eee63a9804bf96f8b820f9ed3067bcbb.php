...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Sale</a></div>
...
<form id="form_data" method="POST"  >
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="hidden"  name="DOC_ID"     id="DOC_ID" value="<?php echo e(isset($HDR->VCS_ID)?$HDR->VCS_ID:''); ?>" >
        ...
        <div class="col-lg-1 pl"><p>Card No</p></div>
        <div class="col-lg-2 pl">      
          <input type="text" name="CARD_NAME" id="CARD_NAME" onclick="searchCardMaster()" class="form-control" value="<?php echo e(isset($HDR->CARDNO)?$HDR->CARDNO:''); ?>" autocomplete="off" readonly>
          <input type="hidden" name="CARD_ID" id="CARD_ID" class="form-control" autocomplete="off" value="<?php echo e(isset($HDR->CARDID_REF)?$HDR->CARDID_REF:''); ?>" >
        </div>

      <div class="col-lg-1 pl"><p>Validity Month</p></div>
      <div class="col-lg-2 pl">
      <input type="text" name="VALIDITY_MONTH" id="VALIDITY_MONTH" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->VALIDITY_MONTH)?$HDR->VALIDITY_MONTH:''); ?>" class="form-control" style="text-transform:uppercase">
      </div>

      <div class="col-lg-1 pl"><p>Card Amount</p></div>
      <div class="col-lg-2 pl">
      <input type="text" name="TOTAL_CARD_AMOUNT" id="TOTAL_CARD_AMOUNT" <?php echo e($ActionStatus); ?>  readonly value="<?php echo e(isset($HDR->CARD_AMT)?$HDR->CARD_AMT:''); ?>" class="form-control">
      </div>
  ...
  <div class="row">
      <div class="col-lg-1 pl"><p>Validity From</p></div>
      <div class="col-lg-2 pl">
      <input type="date" name="VALIDITY_START_FROM" <?php echo e($ActionStatus); ?>  id="VALIDITY_START_FROM" value="<?php echo e(isset($HDR->VALIDITY_FROM)?$HDR->VALIDITY_FROM:''); ?>" class="form-control" >
      </div>

      <div class="col-lg-1 pl"><p>Validity Till</p></div>
      <div class="col-lg-2 pl">
      <input type="date" name="VALIDITY_START_TO" id="VALIDITY_START_TO" <?php echo e($ActionStatus); ?>  value="<?php echo e(isset($HDR->VALIDITY_TO)?$HDR->VALIDITY_TO:''); ?>" class="form-control">
      </div>
        ...
        <div class="col-lg-3 pl"></div>
        <div class="col-lg-1 pl"><p>Tax Amount</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_TAX_AMOUNT" id="TOTAL_TAX_AMOUNT"  <?php echo e($ActionStatus); ?>  readonly value="<?php echo e(isset($HDR->TAX_AMT)?$HDR->TAX_AMT:''); ?>" class="form-control" style="text-transform:uppercase">
        </div>
      </div>
      ...
      <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_DISCOUONT_AMOUNT" id="TOTAL_DISCOUONT_AMOUNT" <?php echo e($ActionStatus); ?>  readonly value="<?php echo e(isset($HDR->DISCOUNT_AMT)?$HDR->DISCOUNT_AMT:''); ?>" class="form-control" style="text-transform:uppercase">
        </div>
        </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_NET_AMOUNT" id="TOTAL_NET_AMOUNT"  readonly value="<?php echo e(isset($HDR->NET_AMT)?$HDR->NET_AMT:''); ?>"  <?php echo e($ActionStatus); ?>  class="form-control">
        </div>
        </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TOTAL_PAID_AMOUNT" id="TOTAL_PAID_AMOUNT"  readonly value="<?php echo e(isset($HDR->PAID_AMT)?$HDR->PAID_AMT:''); ?>"  <?php echo e($ActionStatus); ?>  class="form-control">
        </div>
      </div>
            ...
            <div class="table-responsive table-wrapper-scroll-y" style="height:280px;margin-top:10px;">
              <table class="display nowrap table table-striped table-bordered itemlist w-200" style="height:auto !important;width:50%">
                <thead>
                  ...
                  <?php $__currentLoopData = $TAX; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr class="taxRow">
                    <td><input  type="text" name="TAX_NAME[]"   id="TAX_NAME_<?php echo e($key); ?>"    value="<?php echo e(isset($row->TAX_NAME)?$row->TAX_NAME:''); ?>"     class="form-control"  autocomplete="off" <?php echo e($ActionStatus); ?> /></td>
                    <td><input  type="text" name="TAX_PER[]"    id="TAX_PER_<?php echo e($key); ?>"     value="<?php echo e(isset($row->TAX_PER)?$row->TAX_PER:''); ?>"       class="form-control"  autocomplete="off" onkeyup="getTaxAmount(this.id,this.value)" onkeypress="return isNumberDecimalKey(event,this)" <?php echo e($ActionStatus); ?> /></td>
                    <td><input  type="text" name="TAX_AMOUNT[]" id="TAX_AMOUNT_<?php echo e($key); ?>"  value="<?php echo e(isset($row->TAX_AMOUNT)?$row->TAX_AMOUNT:''); ?>" class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td align="center" >
                      <button class="btn add material" title="add" data-toggle="tooltip" type="button" <?php echo e($ActionStatus); ?> ><i class="fa fa-plus"></i></button>
                      <button class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button" <?php echo e($ActionStatus); ?> ><i class="fa fa-trash" ></i></button>
                    </td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php endif; ?>
          ...
          <div id="Payment" class="tab-pane fade in ">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px; width: 786px"  >
              <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                  <?php if(isset($PAY) && !empty($PAY)): ?>
                  <?php $__currentLoopData = $PAY; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr class="participantRow2">
                    <td>
                      <select <?php echo e($ActionStatus); ?> name="PAYMENT_TYPE[]" id="PAYMENT_TYPE_<?php echo e($key); ?>" class="form-control" onchange="getDocType(this.id);">
                        <option  value="">Select</option>
                        <option <?php echo e(isset($row->PAYMENT_TYPE) && $row->PAYMENT_TYPE =='Cash'?'selected="selected"':''); ?> value="Cash">Cash</option>
                        <option <?php echo e(isset($row->PAYMENT_TYPE) && $row->PAYMENT_TYPE =='Value Card'?'selected="selected"':''); ?> value="Value Card">Value Card</option>
                        <option <?php echo e(isset($row->PAYMENT_TYPE) && $row->PAYMENT_TYPE =='Credit Card'?'selected="selected"':''); ?> value="Credit Card">Credit Card</option> 
                        <option <?php echo e(isset($row->PAYMENT_TYPE) && $row->PAYMENT_TYPE =='FOC'?'selected="selected"':''); ?> value="FOC">FOC</option>
                      </select>
                    </td>

                    <td><input        type="text"   name="DESCRIPTION[]"  id="DESCRIPTION_<?php echo e($key); ?>" value="<?php echo e(isset($row->DESCRIPTION)?$row->DESCRIPTION:''); ?>" class="form-control"  autocomplete="off"  onclick="getValueCardMaster(this.id)" <?php echo e(isset($row->PAYMENT_TYPE) && $row->PAYMENT_TYPE =='Value Card'?'readonly':''); ?> <?php echo e($ActionStatus); ?> /></td>
                    <td hidden><input type="hidden" name="VALUEID_REF[]"  id="VALUEID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->VALUEID_REF)?$row->VALUEID_REF:''); ?>" class="form-control"  autocomplete="off" <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text"   name="PAID_AMT[]"     id="PAID_AMT_<?php echo e($key); ?>"    value="<?php echo e(isset($row->PAID_AMT)?$row->PAID_AMT:''); ?>"       class="form-control two-digits" onkeyup="getPaymentAmount(this.id,this.value)" onkeypress="return isNumberDecimalKey(event,this)"  onfocusout="dataDec(this,'2')"   autocomplete="off" <?php echo e($ActionStatus); ?>  /></td>
                             
                    <td align="center" >
                      <button class="btn add ainvoice" title="add" data-toggle="tooltip" type="button" <?php echo e($ActionStatus); ?>><i class="fa fa-plus"></i></button>
                      <button class="btn remove dinvoice" title="Delete" data-toggle="tooltip" type="button" <?php echo e($ActionStatus); ?>><i class="fa fa-trash" ></i></button>
                    </td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php endif; ?>     
...
function loadTax(){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"loadTax"])); ?>',
    type:'POST',
...
$.ajax({
  url:'<?php echo e(route("transaction",[$FormId,"searchCard"])); ?>',
  type:'POST',
 // data:{SEARCH_ITEM:SEARCH_ITEM},
  success:function(data) {
    var html = '';
    ...
    if(data.length > 0){
      $.each(data, function(key, value) {
        html +='<tr>';
        html +='<td style="width:10%;text-align:center;" ><input type="checkbox" id="key_'+key+'" value="'+value.DOC_ID+'" onChange="bindCardMaster(this)" data-code="'+value.DOC_NO+'" data-desc="'+value.DOC_DATE+'" data-cardamount="'+value.TOTAL_AMT+'" data-discount="'+value.PERCENTAGE_AMT+'" data-netamount="'+value.VCA_AMT+'" data-validitymonth="'+value.CARDVALIDITY_MON+'"></td>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/transactions/sales/ValueCardSales/trnfrm543view.blade.php ENDPATH**/ ?>