...
<div class="container-fluid purchase-order-view filter">     
    ...
    <div class="row">
        ...
        <input type="text" name="LEAD_NO" id="LEAD_NO" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      <?php elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1"): ?>
        <input type="text" name="LEAD_NO" id="LEAD_NO" value="<?php echo e(old('LEAD_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objDD->MANUAL_MAXLENGTH)?$objDD->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
      <?php else: ?>
        <input type="text" name="LEAD_NO" id="LEAD_NO" value="<?php echo e(old('BGCODE')); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        <?php endif; ?>
      </div>
      <div class="col-lg-2 pl"><p>Lead Date*</p></div>
        <div class="col-lg-2 pl">
        <input type="date" name="LEAD_DT" id="LEAD_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(old('LEAD_DT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
      </div> 
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
        <input type="date" name="EXPECTED_DT" id="EXPECTED_DT" value="<?php echo e(old('EXPECTED_DT')); ?>" class="form-control mandatory" autocomplete="off" readonly >
      </div>
    
      <div class="col-lg-2 pl"><p>Opportunity Date</p></div>
        <div class="col-lg-2 pl">
        <input type="date" name="OPPORTUNITY_DT" id="OPPORTUNITY_DT" value="<?php echo e(old('OPPORTUNITY_DT')); ?>" class="form-control mandatory" autocomplete="off" readonly>
      </div>
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="FNAME" id="FNAME" value="<?php echo e(old('FNAME')); ?>" class="form-control mandatory" autocomplete="off">                            
      </div>
    
      <div class="col-lg-2 pl"><p>Last Name</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="LNAME" id="LNAME" value="<?php echo e(old('LNAME')); ?>" class="form-control mandatory" autocomplete="off">                            
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="PINCODE" id="PINCODE" value="<?php echo e(old('PINCODE')); ?>" onkeypress="return onlyNumberKey(event)" maxlength="6" class="form-control mandatory" autocomplete="off">                             
      </div>
      ...
      <div class="col-lg-2 pl">
        ...
        <input type="hidden" name="LOWNERID_REF" id="LOWNERID_REF" value="<?php if(Session::get('branch_name')): ?> <?php echo e(Session::get('branch_name')); ?> <?php endif; ?>" class="form-control" autocomplete="off" />
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="LSTATUS" id="LSTATUS" onclick="getData('<?php echo e(route('transaction',[$FormId,'getLeadStatusCode'])); ?>','Lead Status Details')" class="form-control mandatory"  autocomplete="off" readonly/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\PreSales\LeadGeneration\trnfrm439add.blade.php ENDPATH**/ ?>