                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                ...
                                                ?>
                                                    ...
                                                    <td><input type="text" name=<?php echo e("LEADDT_".$key); ?> id=<?php echo e("LEADDT_".$key); ?>  class="form-control"  autocomplete="off"  readonly value="<?php echo e($row->LEAD_DT); ?>"  style="width:130px;"/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\sales\SalesOrder\trnfrm38amendment.blade.php ENDPATH**/ ?>