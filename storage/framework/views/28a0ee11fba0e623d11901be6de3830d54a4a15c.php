                    ...
                    <div class="inner-form">
                      ...
                      <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="checkbox" name="LBLSOFC" id="LBLSOFC" class="form-checkbox" value="<?php echo e(isset($objSO->SOFC) && $objSO->SOFC == 1 ? 1 : 0); ?>"  <?php echo e(isset($objSO->SOFC) && $objSO->SOFC == 1 ? 'checked' : ''); ?> disabled >
                                <input type="hidden" name="SOFC" id="SOFC" value="<?php echo e(isset($objSO->SOFC) && $objSO->SOFC == 1 ? 1 : 0); ?>" class="form-control">
                            </div>

                            <div class="col-lg-2 pl"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                <?php if(count($objsocurrency) > 0): ?>
                                <input type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objsocurrency[0])?$objsocurrency[0]:''); ?>"   disabled/>
                                <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSO->CONVFACT)?$objSO->CONVFACT:''); ?>" readonly/>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesOrder\trnfrm38amendment.blade.php ENDPATH**/ ?>