        ...
        <div class="inner-form">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 pl"><?php echo e(isset($objResponse->CCODE) && $objResponse->CCODE !=''?$objResponse->CCODE:''); ?> <?php echo e(isset($objResponse->CUSTNAME) && $objResponse->CUSTNAME !=''?'- '.$objResponse->CUSTNAME:''); ?> <?php echo e(isset($objResponse->PCODE) && $objResponse->PCODE !=''?$objResponse->PCODE:''); ?> <?php echo e(isset($objResponse->PROSNAME) && $objResponse->PROSNAME !=''?'- '.$objResponse->PROSNAME:''); ?>
              ...
              <input type="hidden" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE" value="<?php echo e(isset($objResponse->CUSTOMER_TYPE) && $objResponse->CUSTOMER_TYPE !=''?$objResponse->CUSTOMER_TYPE:''); ?>" class="form-control" autocomplete="off" disabled/>
              <input type="hidden"  id="CUSTOMERPROSPECT_NAME" onclick="getCustProspect()" value="<?php echo e(isset($objResponse->CCODE) && $objResponse->CCODE !=''?$objResponse->CCODE:''); ?><?php echo e(isset($objResponse->CUSTNAME) && $objResponse->CUSTNAME !=''?'- '.$objResponse->CUSTNAME:''); ?> <?php echo e(isset($objResponse->PCODE) && $objResponse->PCODE !=''?$objResponse->PCODE:''); ?> <?php echo e(isset($objResponse->PROSNAME) && $objResponse->PROSNAME !=''?'- '.$objResponse->PROSNAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly disabled/>
              <input type="hidden" name="CUSTOMER_PROSPECT" id="CUSTOMER_PROSPECT" value="<?php echo e(isset($objResponse->CUSTOMER_PROSPECT) && $objResponse->CUSTOMER_PROSPECT !=''?$objResponse->CUSTOMER_PROSPECT:''); ?>" class="form-control" autocomplete="off" disabled/>
            </div>
              ...
              <div class="col-lg-3 pl"><?php echo e(isset($objResponse->FIRST_NAME) && $objResponse->FIRST_NAME !=''?$objResponse->FIRST_NAME:''); ?>
            ...
            <div class="col-lg-3 pl"><?php echo e(isset($objResponse->LAST_NAME) && $objResponse->LAST_NAME !=''?$objResponse->LAST_NAME:''); ?>
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl"><p>Additonal Member Visit*</p></div>
                <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="text" name="ADDMEMBER_VISIT" id="ADDMEMBER_VISIT" onclick="getData('<?php echo e(route('transaction',[$FormId,'getAddMemberVisitCode'])); ?>','Activity Type Details','ADDMEMBER_VISIT_REF')" class="form-control mandatory" autocomplete="off" readonly>
                  <input <?php echo e($ActionStatus); ?> type="hidden" name="ADDMEMBERVISIT_REF" id="ADDMEMBER_VISIT_REF" class="form-control mandatory">                              
                </div>
        ...
        <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
         ...
         <tbody>
          ...
          <tr  class="participantRow">   
            ...
            <td><a disabled  <?php echo e($key ==0?'':'disabled'); ?>  class="btn add" title="Edit" id="editrow_<?php echo e($key); ?>" data-toggle="tooltip" style="color: rgb(43, 41, 41);"><i class="fa fa-edit" onclick="getDataVal('<?php echo e($key); ?>')" style="cursor: pointer;"></i></a></td>
          </tr>
          <?php $n++; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\PreSales\FollowUp\trnfrm483view.blade.php ENDPATH**/ ?>