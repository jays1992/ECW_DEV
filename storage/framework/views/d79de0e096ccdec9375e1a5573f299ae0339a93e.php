...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <?php if(!empty($objSON)): ?>
            <?php if($objSON->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="MPPDOCNO" id="MPPDOCNO" value="<?php echo e($objMPPDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus required>
            <?php endif; ?>
            <?php if($objSON->MANUAL_SR == "1"): ?>
                <input type="text" name="MPPDOCNO" id="MPPDOCNO" value="<?php echo e(old('MPPDOCNO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus required>
            <?php endif; ?>
        <?php endif; ?>    
        <span class="text-danger" id="ERROR_MPPDOCNO"></span> 
            ...
            <input type="date" name="MPPDT" id="MPPDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Production\ManualProductionPlan\trnfrm229add.blade.php ENDPATH**/ ?>