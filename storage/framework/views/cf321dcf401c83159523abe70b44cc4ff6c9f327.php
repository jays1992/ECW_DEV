              ...
              <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" style="height:auto !important;width:50%">
                <thead id="thead1"  style="position: sticky;top: 0">
                  <tr>
                    ...
                    <td><input type="text" name="AMOUNT[]" id="AMOUNT_0" onkeypress="return isNumberDecimalKey(event,this)" onkeyup="get_total_amount()"  class="form-control"  autocomplete="off" readonly  /></td>
...
function get_package_amount(PACKAGE_REF){
  var posts = $.ajax({
			url:'<?php echo e(route("transaction",[$FormId,"get_package_amount"])); ?>',
			type:'POST',
			async: false,
			dataType: 'json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/transactions/sales/JobEstimation/trnfrm538add.blade.php ENDPATH**/ ?>