...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Discount Master</a>
    </div>
  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->DISID); ?>" value="<?php echo e($val->DISID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->DISCODE) && $val->DISCODE !=''?$val->DISCODE:''); ?></td>
          <td><?php echo e(isset($val->DOC_DATE) && $val->DOC_DATE !='' && $val->DOC_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DOC_DATE)):''); ?></td>
          <td><?php echo e(isset($val->DESCRIPTION) && $val->DESCRIPTION !=''?$val->DESCRIPTION:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\DiscountMaster\mstfrm527.blade.php ENDPATH**/ ?>