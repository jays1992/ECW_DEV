            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($objRON->SYSTEM_GRSR) && $objRON->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="RONO" id="RONO" value="<?php echo e(isset($objRONO)?$objRONO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            <?php elseif(isset($objRON->MANUAL_SR) && $objRON->MANUAL_SR == "1"): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\ReleaseOrder\trnfrm315add.blade.php ENDPATH**/ ?>