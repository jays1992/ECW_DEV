<?php $__env->startSection('content'); ?>
    ...
    <div class="row" >
        ...
        <div class="col-lg-2 pl">
          <input type="text"   name="BRANCH_NAME" id="BRANCH_NAME"  class="form-control"  autocomplete="off"  onclick="getBranchMaster()" readonly required/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Common/DocumentNumberDefinition/mstfrm145add.blade.php ENDPATH**/ ?>