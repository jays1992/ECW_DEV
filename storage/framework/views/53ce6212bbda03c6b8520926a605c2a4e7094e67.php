      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
            <input type="text" name="FD_CODE" id="FD_CODE" value="<?php echo e(isset($objAutoGenNo)?$objAutoGenNo:''); ?>" class="form-control"  autocomplete="off" readonly style="text-transform:uppercase"  >
          <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="FD_CODE" id="FD_CODE"  class="form-control" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php else: ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="FD_DATE" id="FD_DATE" value="<?php echo e(date('Y-m-d')); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\FixedDeposit\trnfrm501add.blade.php ENDPATH**/ ?>