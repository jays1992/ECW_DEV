          ...
          <div class="inner-form">
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <?php else: ?>
                      <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(old('DOC_NO')); ?>"  class="form-control mandatory"  autocomplete="off" style="text-transform:uppercase"  >
                      <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\PreSales\EmployeeHierarchyMaster\mstfrm505add.blade.php ENDPATH**/ ?>