            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="radio" onclick='return false'  name="LEAD" id="WITH_LEAD" <?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" || $objSQ->QUOTATTION_TYPE =="CUSTOMER" ? "checked":""); ?> value="WITH_LEAD" class="form-radio" >
                            </div>                            
                            
                            <div class="col-lg-2 pl"><p>Without Lead</p></div>
                            <div class="col-lg-2 pl">
                            <input type="radio" name="LEAD" onclick='return false' <?php echo e($objSQ->QUOTATTION_TYPE =="DIRECT" ? "checked":""); ?> id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="date" name="SQDT" id="SQDT" onchange="checkPeriodClosing(36,this.value,1)"  value="<?php echo e(isset($objSQ->SQDT)?$objSQ->SQDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input disabled type="checkbox" name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objSQ->FC) && $objSQ->FC == 1 ? 'checked' : ''); ?> >
                            </div>
                            
                            <div class="col-lg-2 pl "><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                <?php if($objSQcurrency): ?>
                                <input disabled type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e($objSQcurrency); ?>"   />
                                <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input disabled type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSQ->CONVFACT)?$objSQ->CONVFACT:''); ?>" <?php echo e(isset($objSQ->FC) && $objSQ->FC == 1 ? 'readonly' : 'disabled'); ?> />
                            </div>
                        </div>
                                            ...
                                            <?php if(!empty($objSQMAT)): ?>
                                                <?php $__currentLoopData = $objSQMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        ...
                                                        <input style="width:100px;" type="text" name=<?php echo e("txtSE_popup_".$key); ?> id=<?php echo e("txtSE_popup_".$key); ?> class="form-control"   autocomplete="off" value="<?php echo e($row->ENQNO); ?>"   readonly/></td>
                                                        ...
                                                        <td><input style="width:100px;" type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ItemName); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SEMUOM_".$key); ?> id=<?php echo e("SEMUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->SEMUOM); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SEMUOMQTY_".$key); ?> id=<?php echo e("SEMUOMQTY_".$key); ?> class="form-control" maxlength="13" value="<?php echo e($row->SEMUOMQTY); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SEAUOM_".$key); ?> id=<?php echo e("SEAUOM_".$key); ?> class="form-control"  autocomplete="off"  value="<?php echo e($row->SEAUOM); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SEAUOMQTY_".$key); ?> id=<?php echo e("SEAUOMQTY_".$key); ?> class="form-control" maxlength="13" value="<?php echo e($row->SEAUOMQTY); ?>" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("SQ_QTY_".$key); ?> id=<?php echo e("SQ_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->SQ_QTY); ?>"  autocomplete="off"  /></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->ALT_UOMID_QTY); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits blurRate" maxlength="13" value="<?php echo e($row->RATEPUOM); ?>"  autocomplete="off" /></td>
                                                        <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits " maxlength="8" value="<?php echo e($row->DISCPER); ?>"  autocomplete="off" style="width: 50px;" /></td>
                                                        <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DISCOUNT_AMT); ?>" maxlength="15"  autocomplete="off"  /></td>
                                                        <?php
                                                            $TaxAmt=number_format((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT),2, '.', '');
                                                        ?>
                                                        <td><input type="text" name=<?php echo e("DISAFTT_AMT_".$key); ?> id=<?php echo e("DISAFTT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($TaxAmt); ?>" readonly/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($IGSTAMT); ?>"  readonly/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($CGSTAMT); ?>"  readonly/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($SGSTAMT); ?>"  readonly/></td>
                                                        <?php
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                            $SGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->SGST)/100),2, '.', '');
                                                        ...
                                                        ?>
                                                        <td><input type="text" name=<?php echo e("TGST_AMT_".$key); ?> id=<?php echo e("TGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($TOTGST); ?>"   readonly/></td>
                                                        <?php
                                                            $TaxAmt=number_format((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT),2, '.', '');
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                        ...
                                                        ?>
                                                        <td><input type="text" name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($TOTAMT); ?>" readonly/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesQuotation\trnfrm36amendment.blade.php ENDPATH**/ ?>