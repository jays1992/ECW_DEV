                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <?php elseif(isset($objSOSN->MANUAL_SR) && $objSOSN->MANUAL_SR == "1"): ?>
                                <input type="text" name="SOSNO" id="SOSNO"  class="form-control mandatory" maxlength="<?php echo e(isset($objSOSN->MANUAL_MAXLENGTH)?$objSOSN->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                            <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\ScheduleOpenSalesOrder\trnfrm41add.blade.php ENDPATH**/ ?>