          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <?php if(!empty($objDDNO)): ?>
                        <?php if($objDDNO->SYSTEM_GRSR == "1"): ?>
                            <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" value="<?php echo e($objDPDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus required>
                        <?php endif; ?>
                        <?php if($objDDNO->MANUAL_SR == "1"): ?>
                            <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" value="<?php echo e(old('LOAN_DISB_DOCNO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objDDNO->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus required>
                        <?php endif; ?>
                    <?php endif; ?>    
                  ...
                  <div class="col-lg-2 pl"><p>LD Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LOAN_DISB_DOCDT" id="LOAN_DISB_DOCDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Payroll\LoanDisbursement\trnfrm403add.blade.php ENDPATH**/ ?>