        ...
        <div class="col-lg-2 pl">
            <?php if($objPBDOCNO): ?>
              <?php if($objPBDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="JWINO" id="JWINO" value="<?php echo e($objDataNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
              <?php endif; ?>
              <?php if($objPBDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="JWINO" id="JWINO" value="<?php echo e(old('JWINO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objPBDOCNO->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase"  >
              <?php endif; ?>
            <?php else: ?>
                <input type="text" name="JWINO" id="JWINO" value="<?php echo e(old('JWINO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" >
            <?php endif; ?>
        </div>
        <div class="col-lg-2 pl"><p>JWI Doc Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="JWIDT" id="JWIDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(old('JWIDT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\JobWork\JobWorkInvoice\trnfrm359add.blade.php ENDPATH**/ ?>