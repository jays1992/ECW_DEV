	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e(isset($objAFSNO)?$objAFSNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            <?php elseif($objSON->MANUAL_SR == "1"): ?>
                <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e(old('AFSNO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase"  >
            <?php else: ?>
      ...
      <input type="hidden" name="ASFDT" id="ASFDT" class="form-control" autocomplete="off" />
            ...
            <input type="date" name="AFSDT" id="AFSDT" onchange="checkPeriodClosing(168,this.value,1)" value="<?php echo e(old('AFSDT')); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\AnnualForecastSales\trnfrm168add.blade.php ENDPATH**/ ?>