...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              <?php if(isset($objJV->SYSTEM_GRSR) && $objJV->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="MJV_NO" id="MJV_NO" value="<?php echo e(isset($objJVNO)?$objJVNO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              
              <?php elseif(isset($objJV->MANUAL_SR) && $objJV->MANUAL_SR == "1"): ?>
                  <input type="text" name="MJV_NO" id="MJV_NO" value="<?php echo e(old('MJV_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objJV->MANUAL_MAXLENGTH)?$objJV->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
              <?php else: ?>
        ...
        <div class="col-lg-2 pl">
                  <input type="date" name="MJV_DT" id="MJV_DT" value="<?php echo e(old('MJV_DT')); ?>" onchange="checkPeriodClosing(415,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" <?php if(isset($DOC_TYPE) && $DOC_TYPE !=''){?> onchange='getDocNoByEvent("MJV_NO",this,<?php echo json_encode($doc_req);?>)' <?php } ?> />
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\ManualJournalVoucher\trnfrm415add.blade.php ENDPATH**/ ?>