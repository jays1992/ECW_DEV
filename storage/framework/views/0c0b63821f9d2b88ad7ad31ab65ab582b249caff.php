                        ...
                        <div class="row">                            
                            <div class="col-lg-2 pl"><p>Price Level Code </p></div>
                                ...
                                <div class="col-lg-2 pl">
                                  <input type="text" name="PLCODE" id="PLCODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" />
                                      <span class="text-danger" id="ERROR_PLCODE"></span> 
                                </div>
                            <div class="col-lg-2 pl"><p>Price Level Name</p></div>
                                <div class="col-lg-2 pl">
                                  <input type="text" name="PLNAME" id="PLNAME" class="form-control mandatory" value="<?php echo e(old('PLNAME')); ?>" maxlength="200" tabindex="2"  />
...
$.ajax({
    url:'<?php echo e(route("master",[526,"save"])); ?>',
    type:'POST',
    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\PriceLevel\mstfrm526add.blade.php ENDPATH**/ ?>