                ...
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                  ...
                  <?php if(!empty($objRCPTACCOUNT)): ?>
                    <?php $__currentLoopData = $objRCPTACCOUNT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gkey => $grow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr  class="participantRow3">
                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupAccount_".$gkey); ?> id=<?php echo e("popupAccount_".$gkey); ?> class="form-control" value="<?php echo e($grow->GLCODE); ?>" autocomplete="off" readonly/></td>
                          ...
                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("AccountName_".$gkey); ?> id=<?php echo e("AccountName_".$gkey); ?> class="form-control"  autocomplete="off" value="<?php echo e($grow->GLNAME); ?>" readonly/></td>
                      ...
                      ?>
                          ...
                          <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CCID_REF_".$gkey); ?> id=<?php echo e("CCID_REF_".$gkey); ?> class="form-control"  autocomplete="off" value="<?php echo e($grow->CCID_REF); ?>"  readonly/></td>
                          <td>
                  ...
                  <?php else: ?>
                      <tr  class="participantRow3">
                          ...
                          <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="CCID_REF_0" id="CCID_REF_0" class="form-control"  autocomplete="off"  readonly/></td>
    ...
    <input type="text" id="Accountnamesearch" class="form-control" onkeyup="AccountNameFunction()">
      ...
      <table id="AccountCodeTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objgeneralledger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$glRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
          <td style="text-align:center; width:10%"> <input type="checkbox"   id="glidcode_<?php echo e($index); ?>" class="clsglid" value="<?php echo e($glRow->GLID); ?>" name="glname[]" ></td>
              <td style="width:30%"><?php echo e($glRow-> GLCODE); ?>
              ...
              <td style="width:60%"><?php echo e($glRow-> GLNAME); ?></td>
          </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
 ...
 <div class="modal-dialog modal-md" style="width:90%;">
    ...
    <tr>
      ...
      <table id="Bank2CodeTable2" class="display nowrap table  table-striped table-bordered" style="width:100%;">
        ...
        <?php $__currentLoopData = $objBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$bkRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td style="width:7%; text-align: center;"><input type="checkbox" id="bkidcode2_<?php echo e($index); ?>" name="CASHBANKPOPUP2[]" value="<?php echo e($bkRow-> BID); ?>" class="js-selectall1 clsbkid2"  ></td>

              
              <td style="width:13%;"><?php echo e($bkRow-> BCODE); ?>
              ...
              <td style="width:13%;"><?php echo e($bkRow-> NAME); ?></td>
              <td style="width:13%;"><?php echo e($bkRow-> BRANCH); ?></td>
              <td style="width:13%;"><?php echo e($bkRow-> IFSC); ?></td>
              <td style="width:13%;"><?php echo e($bkRow-> ACTYPE); ?></td>
              <td style="width:13%;"><?php echo e($bkRow-> ACNO); ?></td>
              <td style="width:15%;"><?php echo e($bkRow-> ADD1); ?> <?php echo e($bkRow-> ADD2); ?> <?php echo e($bkRow-> CITY); ?> <?php echo e($bkRow-> STATE); ?> <?php echo e($bkRow-> COUNTRY); ?> <?php echo e($bkRow-> PIN); ?></td>
          </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
$('#btnPrint').on('click', function() {
            var DOCID    ='<?php echo e($objRCPTHDR->RECEIPTID); ?>';     
            var Flag    = 'H';
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[302,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
  ...
  $('#btnExcel').on('click', function() {
            ...
            var Flag = 'E';
            var formData = 'SO='+ DOCID + '&RECEIPTID='+ DOCID + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[302,"ViewReport",":rcdId"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\Accounts\ReceiptEntry\trnfrm302view.blade.php ENDPATH**/ ?>