...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Promo Master</a>
    </div>
  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->PROMOID); ?>" value="<?php echo e($val->PROMOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->PROMOCODE) && $val->PROMOCODE !=''?$val->PROMOCODE:''); ?></td>
          <td><?php echo e(isset($val->PROMODATE) && $val->PROMODATE !='' && $val->PROMODATE !='1900-01-01' ? date('d-m-Y',strtotime($val->PROMODATE)):''); ?></td>
          <td><?php echo e(isset($val->VALID_DATE) && $val->VALID_DATE !='' && $val->VALID_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->VALID_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/PromoMaster/mstfrm525.blade.php ENDPATH**/ ?>