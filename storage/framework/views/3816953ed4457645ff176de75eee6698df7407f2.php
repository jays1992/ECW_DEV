...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Vehicle Make Master</a>
    </div>
  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->VM_ID); ?>" value="<?php echo e($val->VM_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->VM_NO) && $val->VM_NO !=''?$val->VM_NO:''); ?></td>
          <td><?php echo e(isset($val->VM_DATE) && $val->VM_DATE !=''?$val->VM_DATE:''); ?></td>
          <td><?php echo e(isset($val->VM_NAME) && $val->VM_NAME !=''?$val->VM_NAME:''); ?></td> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/VehicleMakeMaster/mstfrm537.blade.php ENDPATH**/ ?>