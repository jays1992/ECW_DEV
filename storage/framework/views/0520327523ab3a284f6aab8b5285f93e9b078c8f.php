      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            <?php if($objSON->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="QIJNO" id="QIJNO" value="<?php echo e($objAutoGenNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <?php endif; ?>
            <?php if($objSON->MANUAL_SR == "1"): ?>
                <input type="text" name="QIJNO" id="QIJNO" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="QIJDT" id="QIJDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\JobWork\QualityInspection\trnfrm358add.blade.php ENDPATH**/ ?>