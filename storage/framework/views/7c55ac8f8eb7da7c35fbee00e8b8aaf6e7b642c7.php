         ...
         <form id="frm_mst_country" method="POST"  > 
          ...
          <div class="inner-form">
                  ...
                  <div class="col-lg-3 pl">
                    <?php if(!empty($objDD)): ?>
                        <?php if(isset($objDD->SYSTEM_GRSR) && $objDD->SYSTEM_GRSR == "1"): ?>
                            <input type="text" name="CTRYCODE" id="CTRYCODE" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                        <?php endif; ?>
                        <?php if(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1"): ?>
                            <input type="text" name="CTRYCODE" id="CTRYCODE" value="<?php echo e(old('CTRYCODE')); ?>" class="form-control mandatory" minlength="3" maxlength="<?php echo e($objDD->MANUAL_MAXLENGTH); ?>" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                        <?php endif; ?>
                    <?php endif; ?>    
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl ">
                  <input type="text" name="LANG" id="LANG" class="form-control" value="<?php echo e(old('LANG')); ?>"  maxlength="50"  tabindex="4" >
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl">
                  <input type="text" name="CONTINENTAL" id="CONTINENTAL" class="form-control" value="<?php echo e(old('CONTINENTAL')); ?>" maxlength="50"  tabindex="5" >
                </div>
                
                <div class="col-lg-2 pl col-md-offset-1"><p>Capital</p></div>
                <div class="col-lg-3 pl">
                  <input type="text" name="CAPITAL" id="CAPITAL" class="form-control"  value="<?php echo e(old('CAPITAL')); ?>"   maxlength="50"  tabindex="6" >
                </div>
              </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/country/mstfrm4add.blade.php ENDPATH**/ ?>