                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 pl">
                    <div class="col-lg-7 pl">
                        <input type="text" <?php echo e($objResponse->STATUS =="A" ? 'disabled':''); ?> name="PUR_AC_SET_POPUP" id="PUR_AC_SET_POPUP" value="<?php echo e($PurAccountListName); ?>" class="form-control mandatory" readonly tabindex="3" required />
                  ...
                  <div class="col-lg-3 pl">
                    <div class="col-lg-7 pl">
                        <input type="text" <?php echo e($objResponse->STATUS =="A" ? 'disabled':''); ?> name="SALE_AC_SET_POPUP" id="SALE_AC_SET_POPUP" value="<?php echo e($salesAccountListName); ?>" class="form-control mandatory" readonly tabindex="4" required/>
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objDataResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow">
                              <td><input <?php echo e($row->USED > 0 ?'readonly':''); ?>  class="form-control w-100" type="text" name=<?php echo e("ISGCODE_".$key); ?> id =<?php echo e("txtisgcode_".$key); ?>  value="<?php echo e($row->ISGCODE); ?>" maxlength="20" autocomplete="off" style="text-transform:uppercase;width:100%;" onkeypress="return AlphaNumaric(event,this)" ></td>
                              <td>
                              <input  class="form-control w-100" <?php echo e($row->USED > 0 ?'readonly':''); ?> type="text" name=<?php echo e("DESCRIPTIONS_".$key); ?> id =<?php echo e("txtdesc_".$key); ?> value="<?php echo e($row->DESCRIPTIONS); ?>" maxlength="200" autocomplete="off" style="width:100%;" >
                              </td>

                              <td align="center" >
                                  <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                                  <button class="btn remove" title="Delete" data-toggle="tooltip" <?php echo e($row->USED > 0 ?'disabled':''); ?>  ><i class="fa fa-trash" ></i></button>
                              </td>
                          </tr>
                          <?php $n++; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\inventory\ItemGroupAndSubGroup\mstfrm74edit.blade.php ENDPATH**/ ?>