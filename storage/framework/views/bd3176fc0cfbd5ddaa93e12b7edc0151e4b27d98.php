	...
	<div class="inner-form">
        ...
        <?php if(!empty($objSON)): ?>
            <?php if($objSON->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e($objAFSNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <?php endif; ?>
            <?php if($objSON->MANUAL_SR == "1"): ?>
                <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e(old('AFSNO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
        <?php endif; ?>    
			</div>
      ...
      <input type="hidden" name="ASFDT" id="ASFDT" class="form-control" autocomplete="off" />
            ...
            <input type="date" name="AFSDT" id="AFSDT" onchange="checkPeriodClosing(220,this.value,1)" value="<?php echo e(old('AFSDT')); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Purchase\AnnualForecastPurchase\trnfrm220add.blade.php ENDPATH**/ ?>