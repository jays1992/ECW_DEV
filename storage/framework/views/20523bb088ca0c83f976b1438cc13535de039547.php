            ...
            <div id="TaskAllocation" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
              <div class="row">
                ...
                <div class="col-lg-2 pl"><p>Assigned To*</p></div>
                  <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="ASSIGN_TO" id="ASSIGN_TO" value="<?php echo e(isset($TASKALL->EMPCODE) && $TASKALL->EMPCODE !=''?$TASKALL->EMPCODE:''); ?> <?php echo e(isset($TASKALL->FNAME) && $TASKALL->FNAME !=''?'- '.$TASKALL->FNAME:''); ?>" onclick="getData('<?php echo e(route('transaction',[$FormId,'getAssignedTo'])); ?>','Assigned To','ASSIGN_TO_REF_ID')" class="form-control mandatory" autocomplete="off" readonly>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\PreSales\TaskAllocation\trnfrm484edit.blade.php ENDPATH**/ ?>