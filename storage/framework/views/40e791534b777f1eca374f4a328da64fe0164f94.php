            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <?php if(isset($objSOSN->SYSTEM_GRSR) && $objSOSN->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="SOSNO" id="SOSNO" value="<?php echo e(isset($objSOSNO)?$objSOSNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                          
                            <?php elseif(isset($objSOSN->MANUAL_SR) && $objSOSN->MANUAL_SR == "1"): ?>
                                <input type="text" name="SOSNO" id="SOSNO" value="<?php echo e(old('SOSNO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSOSN->MANUAL_MAXLENGTH)?$objSOSN->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                            <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(old('SOSDT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Purchase\ScheduleBlanketPurchaseOrder\trnfrm68add.blade.php ENDPATH**/ ?>