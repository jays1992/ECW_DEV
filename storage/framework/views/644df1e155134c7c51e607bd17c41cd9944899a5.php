                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="CARD_NO[]" id="CARD_NO_<?php echo e($key); ?>" value="<?php echo e(isset($row->CARD_NO)?$row->CARD_NO:''); ?>"      class="form-control"  autocomplete="off" maxlength="16" /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Sales/ValueCardMaster/mstfrm531edit.blade.php ENDPATH**/ ?>