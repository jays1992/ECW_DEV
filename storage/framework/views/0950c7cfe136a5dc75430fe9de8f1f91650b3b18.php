...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
  ...
  <div class="container-fluid filter">
      ...
      <div class="col-lg-2 pl"><p>Doc No*</p></div>
        ...
        <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="date" name="BRC_DT" id="BRC_DT" value="<?php echo e(isset($objResponse->BRC_DT) && $objResponse->BRC_DT !=''?$objResponse->BRC_DT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" >
        ...
        <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         ...
                         <td><input  type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("Main_popupITEMID_".$key); ?> id=<?php echo e("Main_popupITEMID_".$key); ?>  class="form-control"  autocomplete="off" value="<?php echo e($row->ICODE); ?>"  readonly/></td>
                          ...
                          <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("Main_RECEIVED_QTY_".$key); ?> id=<?php echo e("Main_RECEIVED_QTY_".$key); ?>  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly value="<?php echo e($row->RECEIVED_QTY); ?>"  /></td>
...
function validateForm(actionType,actionMsg){
  ...
  $('#material_item').find('.participantRow8').each(function(){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#BRC_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\inventory\Barcode\trnfrm418edit.blade.php ENDPATH**/ ?>