...
<!-- <form id="frm_mst_se" onsubmit="return validateForm()"  method="POST"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <button class="btn topnavbt" onclick="submitData('fnApproveData')"  id="btnApprove" <?php echo e(($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'); ?>><i class="fa fa-thumbs-o-up"></i> Approved</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input <?php echo e($ActionStatus); ?> type="text"  id="CUSTOMERPROSPECT_NAME" onclick="getCustProspect()" value="<?php echo e(isset($objResponse->CCODE) && $objResponse->CCODE !=''?$objResponse->CCODE:''); ?><?php echo e($objResponse->CUSTNAME); ?> <?php echo e(isset($objResponse->PCODE) && $objResponse->PCODE !=''?$objResponse->PCODE:''); ?> <?php echo e($objResponse->PROSNAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          <input <?php echo e($ActionStatus); ?> type="hidden" name="CUSTOMER_PROSPECT" id="CUSTOMER_PROSPECT" value="<?php echo e(isset($objResponse->CUSTOMER_PROSPECT) && $objResponse->CUSTOMER_PROSPECT !=''?$objResponse->CUSTOMER_PROSPECT:''); ?>" class="form-control" autocomplete="off" />
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="FNAME" id="FNAME" value="<?php echo e(isset($objResponse->FIRST_NAME) && $objResponse->FIRST_NAME !=''?$objResponse->FIRST_NAME:''); ?>" class="form-control mandatory" autocomplete="off">                            
          </div>
       
          <div class="col-lg-2 pl"><p>Last Name</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="LNAME" id="LNAME" value="<?php echo e(isset($objResponse->LAST_NAME) && $objResponse->LAST_NAME !=''?$objResponse->LAST_NAME:''); ?>" class="form-control mandatory" autocomplete="off">                            
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="LOWNER" id="LOWNER" value="<?php echo e(isset($objResponse->EMPCODE) && $objResponse->EMPCODE !=''?$objResponse->EMPCODE:''); ?> - <?php echo e($objResponse->FNAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="ASSIGTO" id="ASSIGTO" value="<?php echo e(isset($objResp->ASSGNTOCODE) && $objResp->ASSGNTOCODE !=''?$objResp->ASSGNTOCODE:''); ?> <?php echo e(isset($objResp->ASSGNTOFNAME) && $objResp->ASSGNTOFNAME !=''?'- '.$objResp->ASSGNTOFNAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          <input <?php echo e($ActionStatus); ?> type="hidden" name="ASSIGTOID_REF" id="ASSIGTOID_REF" value="<?php echo e(isset($objResp->ASSIGNTO_REF) && $objResp->ASSIGNTO_REF !=''?$objResp->ASSIGNTO_REF:''); ?>" class="form-control" autocomplete="off" />
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\PreSales\LeadGeneration\trnfrm439edit.blade.php ENDPATH**/ ?>