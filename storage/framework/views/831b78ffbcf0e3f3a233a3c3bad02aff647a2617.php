...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Accessory Invoice</a></div>
  ...
  <div class="container-fluid filter">    
    ...
    <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="hidden"  name="DOC_ID"     id="DOC_ID" value="<?php echo e(isset($HDR->ACCID)?$HDR->ACCID:''); ?>" >
          ...
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($HDR->DOC_DATE)?$HDR->DOC_DATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
            </div>

          <div class="col-lg-1 pl"><p>Exist Customer</p></div>
          <div class="col-lg-1 pl"> <input type="radio" name="CUSTOMER_TYPE" value="EXIST" <?php echo e($ActionStatus); ?>  <?php echo e(isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='EXIST'?'checked':''); ?> onchange="get_customer_type(this.value)" ></div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-1 pl"> <input type="radio" name="CUSTOMER_TYPE" <?php echo e($ActionStatus); ?> value="NEW" <?php echo e(isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='NEW'?'checked':''); ?> onchange="get_customer_type(this.value)" ></div>
        </div>

        <div class="row">
          <div class="col-lg-1 pl"><p>Search</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" id="SEARCH_CUSTOMER" onkeyup="searchItem1(event)" <?php echo e($ActionStatus); ?> class="form-control" autocomplete="off" placeholder='Mobile No' onkeypress="return isNumberKey(event,this)" >
          </div>

          <div class="col-lg-1 pl"> 
            <i class="fa fa-search" onclick="searchCustomerMaster()" <?php echo e($ActionStatus); ?> style="cursor:pointer;margin-top:5px;"></i>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input type="text" name="CUSTOMER_NAME" id="CUSTOMER_NAME" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->CUSTOMER_NAME)?$HDR->CUSTOMER_NAME:''); ?>" class="form-control" autocomplete="off" readonly>
            <input type="hidden" name="CUSTOMER_ID" id="CUSTOMER_ID" value="<?php echo e(isset($HDR->CUSTOMER_ID)?$HDR->CUSTOMER_ID:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Birth Date</p></div>
          <div class="col-lg-2 pl"> 
            <input type="date" name="DOB" id="DOB" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->DOB)?$HDR->DOB:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>E-Mail Id*</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" name="EMAIL_ID" id="EMAIL_ID" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->EMAIL_ID)?$HDR->EMAIL_ID:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Mobile No*</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" name="MOBILE_NO" id="MOBILE_NO" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->MOBILE_NO)?$HDR->MOBILE_NO:''); ?>" class="form-control" autocomplete="off" placeholder='Mobile No' maxlength="12"  onkeypress="return isNumberKey(event,this)" >
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input type="text" name="ADDRESS" id="ADDRESS" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->ADDRESS)?$HDR->ADDRESS:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Anniversary Date</p></div>
          <div class="col-lg-2 pl"> 
            <input type="date" name="ANNIVERSARY_DATE" <?php echo e($ActionStatus); ?> id="ANNIVERSARY_DATE" value="<?php echo e(isset($HDR->ANNIVERSARY_DATE)?$HDR->ANNIVERSARY_DATE:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Country*</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" name="COUNTRY_NAME" id="COUNTRY_NAME" <?php echo e($ActionStatus); ?>  value="<?php echo e(isset($HDR->COUNTRY_NAME)?$HDR->COUNTRY_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getCountryMaster()" readonly >
            <input type="hidden" name="COUNTRY_ID" id="COUNTRY_ID" value="<?php echo e(isset($HDR->COUNTRY_ID)?$HDR->COUNTRY_ID:''); ?>" class="form-control" autocomplete="off">
          </div>
        
          <div class="col-lg-1 pl"><p>State*</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" name="STATE_NAME" id="STATE_NAME" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->STATE_NAME)?$HDR->STATE_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getStateMaster()" readonly >
            <input type="hidden" name="STATE_ID" id="STATE_ID" value="<?php echo e(isset($HDR->STATE_ID)?$HDR->STATE_ID:''); ?>" class="form-control" autocomplete="off">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input type="text" name="CITY_NAME" id="CITY_NAME" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->CITY_NAME)?$HDR->CITY_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getCityMaster()" readonly >
            <input type="hidden" name="CITY_ID" id="CITY_ID" value="<?php echo e(isset($HDR->CITY_ID)?$HDR->CITY_ID:''); ?>" class="form-control" autocomplete="off">
          </div>

          <div class="col-lg-1 pl"><p>Pin Code*</p></div>
          <div class="col-lg-2 pl"> 
          <input type="text" name="PINCODE" id="PINCODE" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->PINCODE)?$HDR->PINCODE:''); ?>" class="form-control" autocomplete="off" maxlength="6" onkeypress="return isNumberKey(event,this)" >
          </div>

          <div class="col-lg-1 pl"><p>GST Type*</p></div>
          <div class="col-lg-2 pl"> 
            <select name="GST_TYPE" id="GST_TYPE" <?php echo e($ActionStatus); ?> class="form-control mandatory" autocomplete="off" >
              ...
              <option <?php echo e(isset($HDR->GST_TYPE) && $HDR->GST_TYPE == $GstType-> GSTID?'selected="selected"':''); ?> value="<?php echo e($GstType-> GSTID); ?>"><?php echo e($GstType->GSTCODE); ?> - <?php echo e($GstType->DESCRIPTIONS); ?></option>
          ...
          <div class="col-lg-2 pl"> 
          <input type="text" name="GST_IN" id="GST_IN" <?php echo e($ActionStatus); ?>  value="<?php echo e(isset($HDR->GST_IN)?$HDR->GST_IN:''); ?>" class="form-control" autocomplete="off">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
          <input type="text" name="LANDLINE_NO" id="LANDLINE_NO" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->LANDLINE_NO)?$HDR->LANDLINE_NO:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberKey(event,this)" >
          </div>

          <div class="col-lg-1 pl"><p>Vehicle Reg No*</p></div>
          <div class="col-lg-2 pl"> 
          <input type="text" name="VEHICLE_REG_NO" id="VEHICLE_REG_NO" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->VEHICLE_REG_NO)?$HDR->VEHICLE_REG_NO:''); ?>" class="form-control" autocomplete="off">
          </div>
        
          <div class="col-lg-1 pl"><p>Vehicle Make*</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" name="VEHICLE_MAKE_NAME" id="VEHICLE_MAKE_NAME" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($HDR->VEHICLE_MAKE_NAME)?$HDR->VEHICLE_MAKE_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getVehicleMakeMaster()" readonly >
            <input type="hidden" name="VEHICLE_MAKE_ID" id="VEHICLE_MAKE_ID" value="<?php echo e(isset($HDR->VEHICLE_MAKE_ID)?$HDR->VEHICLE_MAKE_ID:''); ?>" class="form-control" autocomplete="off">
          </div>
        </div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TotalValue_tax" id="TotalValue_tax" class="form-control" value="<?php echo e(isset($HDR->TAX_AMT)?$HDR->TAX_AMT:''); ?>" autocomplete="off" readonly  />
        </div>
      </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TotalValue" id="TotalValue" class="form-control" value="<?php echo e(isset($HDR->NET_AMT)?$HDR->NET_AMT:''); ?>" autocomplete="off" readonly  />
        </div>
      </div>
        <div class="row">
        <div class="col-lg-9 pl"></div>
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="TotalValue_paid" id="TotalValue_paid" class="form-control" value="<?php echo e(isset($HDR->PAID_AMT)?$HDR->PAID_AMT:''); ?>" autocomplete="off" readonly  />
        </div>
      </div>
          ...
          <div id="Material" class="tab-pane fade in active">
              ...
              <thead id="thead1"  style="position: sticky;top: 0">
                ...
                <?php if(isset($MAT) && !empty($MAT)): ?>
                    ...
                    <td><input  type="text" <?php echo e($ActionStatus); ?> style="width:130px;text-align:left;" name="popupITEMID[]" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e(isset($row->ITEM_CODE)?$row->ITEM_CODE:''); ?>" onclick="getItem(this.id)" class="form-control"  autocomplete="off"  readonly/></td>

                    <td hidden><input type="hidden" name="ITEMID_REF[]" id="ITEMID_REF_<?php echo e($key); ?>"  value="<?php echo e(isset($row->ITEMID_REF)?$row->ITEMID_REF:''); ?>" class="form-control" autocomplete="off" /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> style="width:130px;text-align:left;" name="ItemName[]" id="ItemName_<?php echo e($key); ?>" value="<?php echo e(isset($row->ITEM_NAME)?$row->ITEM_NAME:''); ?>" class="form-control"  autocomplete="off"  readonly  /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> style="width:130px;text-align:left;" name="popupMUOM[]" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e(isset($row->UOM_DESC)?$row->UOM_DESC:''); ?>" onclick="getUomMaster(this.id)" class="form-control"  autocomplete="off"  readonly /></td>

                    <td hidden><input type="hidden" name="MAIN_UOMID_REF[]" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->UOMID_REF)?$row->UOMID_REF:''); ?>" class="form-control"  autocomplete="off" /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> style="width:130px;text-align:right;"   name="QTY[]" id="QTY_<?php echo e($key); ?>" value="<?php echo e(isset($row->QTY)?$row->QTY:''); ?>" class="form-control three-digits"     onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" maxlength="13"  autocomplete="off"   /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?>  name="RATEPUOM[]" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e(isset($row->RATEPUOM)?$row->RATEPUOM:''); ?>" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'5')" /></td>

                    <td><input  type="text" <?php echo e($ActionStatus); ?> name="DISCPER[]" id="DISCPER_<?php echo e($key); ?>" value="<?php echo e(isset($row->DISCPER)?$row->DISCPER:''); ?>" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>

                    <td><input  type="text" <?php echo e($ActionStatus); ?> name="DISCOUNT_AMT[]" id="DISCOUNT_AMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->DISCOUNT_AMT)?$row->DISCOUNT_AMT:''); ?>" class="form-control two-digits" maxlength="15"  autocomplete="off"  style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> name="DISAFTT_AMT[]" id="DISAFTT_AMT_<?php echo e($key); ?>"  value="<?php echo e(isset($row->GROSS_TOTAL)?$row->GROSS_TOTAL:''); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> name="IGST[]" id="IGST_<?php echo e($key); ?>" value="<?php echo e(isset($row->IGST)?$row->IGST:''); ?>"  class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly onkeyup="dataCalculation(this.id)"/></td>

                    <td><input type="text" name="IGSTAMT[]" id="IGSTAMT_<?php echo e($key); ?>"  value="<?php echo e(isset($row->IGSTAMT)?$row->IGSTAMT:''); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> name="CGST[]" id="CGST_<?php echo e($key); ?>" value="<?php echo e(isset($row->CGST)?$row->CGST:''); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:130px;text-align:right;"  onkeyup="dataCalculation(this.id)" /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> name="CGSTAMT[]" id="CGSTAMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->CGSTAMT)?$row->CGSTAMT:''); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                    <td><input type="text" <?php echo e($ActionStatus); ?> name="SGST[]" id="SGST_<?php echo e($key); ?>" value="<?php echo e(isset($row->SGST)?$row->SGST:''); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly  style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" /></td>

                   <td><input type="text" <?php echo e($ActionStatus); ?> name="SGSTAMT[]" id="SGSTAMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->SGSTAMT)?$row->SGSTAMT:''); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>

                   <td><input type="text" <?php echo e($ActionStatus); ?> name="TGST_AMT[]" id="TGST_AMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->TGST_AMT)?$row->TGST_AMT:''); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>

                   <td><input type="text" <?php echo e($ActionStatus); ?> name="TOT_AMT[]" id="TOT_AMT_<?php echo e($key); ?>"  value="<?php echo e(isset($row->TOT_AMT)?$row->TOT_AMT:''); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                    
                  <td align="center" >
                    <button class="btn add material" title="add" <?php echo e($ActionStatus); ?> data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button>
                    <button class="btn remove dmaterial" title="Delete" <?php echo e($ActionStatus); ?> data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
                  </td>
                ...
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <?php $__currentLoopData = $PAYMENT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow2">
                              <td><select <?php echo e($ActionStatus); ?> name="PAYMENT_TYPE[]" id="PAYMENT_TYPE_0" class="form-control" onchange="getDocType(this.id);">
                              <option value="">Select</option>
                              <option value="Cash" <?php echo e(isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Cash" ? 'selected':''); ?> >Cash</option>
                              <option value="Value Card" <?php echo e(isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Value Card" ? 'selected':''); ?>>Value Card</option>
                              <option value="Credit Card" <?php echo e(isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Credit Card" ? 'selected':''); ?>>Credit Card</option> 
                              <option value="FOC" <?php echo e(isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="FOC" ? 'selected':''); ?>>FOC</option>

                              </select></td>      
                              <td>
                              <input type="text" <?php echo e($ActionStatus); ?>  name="DESCRIPTION[]" id="DESCRIPTION_0" value="<?php echo e(isset($row->DESCRIPTION)?$row->DESCRIPTION:''); ?>" <?php echo e(isset($row->PAYMENT_MODE) && $row->PAYMENT_MODE =="Value Card" ? 'readonly':''); ?>   class="form-control"  autocomplete="off"  onclick="getValueCardMaster(this.id)" />
                              </td>
                              <td hidden>
                              <input type="hidden" <?php echo e($ActionStatus); ?> name="VALUEID_REF[]" id="VALUEID_REF_0" value="<?php echo e(isset($row->VCID_REF)?$row->VCID_REF:''); ?>"      class="form-control"  autocomplete="off" />  

                              </td>

                     
                              <td><input type="text" <?php echo e($ActionStatus); ?> name="PAID_AMT[]" id="PAID_AMT_0" value="<?php echo e(isset($row->AMOUNT)?$row->AMOUNT:''); ?>" onkeyup="bindTotalValue()"  onfocusout="dataDec(this,'2')" class="form-control two-digits"  autocomplete="off"  /></td>
                             
                              <td align="center" ><button class="btn add ainvoice" <?php echo e($ActionStatus); ?> title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                              <button class="btn remove dinvoice" <?php echo e($ActionStatus); ?> title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                          </tr>
                          <tr></tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php endif; ?>
...
function getValueCardMaster(id){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"getValueCardMaster"])); ?>',
    type:'POST',
...
//   $.ajax({
//     url:'<?php echo e(route("transaction",[$FormId,"getSacMaster"])); ?>',
//     type:'POST',
//     success:function(data) {
//       var html = '';
...
function loadItem(){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"loadItem"])); ?>',
    type:'POST',
    ...
    success:function(data) {
      ...
      if(data.length > 0){
        $.each(data, function(key, value) {
          ...
          html +='<input type="text" id="txt_Price_'+key+'" value='+value.RATE+' >';
          html +='</td>';
...
function bindItemEvents(){
  ...
  $('[id*="chkId"]').change(function(){
    ...
    var txt_Price     =  $("#txt_Price_"+index).val();
    ...
    if($(this).is(":checked") == true){
      ...
      if(checkExist ==true){
        ...
        $('#RATEPUOM_'+row_id).val(txt_Price);
...
function getUomMaster(textid){
  ...
  if(ITEMID_REF ===""){
    ...
    $.ajax({
      url:'<?php echo e(route("transaction",[$FormId,"getUomMaster"])); ?>',
      type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\sales\AccessoryInvoice\trnfrm541view.blade.php ENDPATH**/ ?>