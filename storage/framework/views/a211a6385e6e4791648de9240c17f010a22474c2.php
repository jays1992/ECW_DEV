                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="">
                                <select name="GLID[]" data-hide-disabled="hide"  multiple data-actions-box="true" id="GLID" class="form-control selectpicker" multiple data-live-search="true"  >
									<?php $__currentLoopData = $objGL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gindex=>$gRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\reports\Accounts\Payment_Report\rptfrm339.blade.php ENDPATH**/ ?>