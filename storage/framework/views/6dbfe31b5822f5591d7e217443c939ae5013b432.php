                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td><input type="text" name="PACKAGE_CODE[]" id="PACKAGE_CODE_<?php echo e($key); ?>"               value="<?php echo e(isset($row->PKMCODE)?$row->PKMCODE:''); ?>"   class="form-control"  autocomplete="off" onclick="getPackage(this.id)"  readonly/></td>
                      <td hidden><input type="text" name="PACKAGE_REF[]" id="PACKAGE_REF_<?php echo e($key); ?>"          value="<?php echo e(isset($row->PACKAGE_REF)?$row->PACKAGE_REF:''); ?>"   class="form-control"  autocomplete="off" /></td>
                      <td><input type="text" name="PACKAGE_NAME[]" id="PACKAGE_NAME_<?php echo e($key); ?>"       value="<?php echo e(isset($row->PKMNAME)?$row->PKMNAME:''); ?>"   class="form-control"  autocomplete="off"  readonly/></td>
                      
                      <td><input type="text" name="PRICE[]"  id="PRICE_<?php echo e($key); ?>"                     value="<?php echo e(isset($row->PRICE)?$row->PRICE:''); ?>"    onkeypress="return isNumberDecimalKey(event,this)" class="form-control"  autocomplete="off"  /></td>
                      <td align="center">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Sales/PackagePriceList/mstfrm561edit.blade.php ENDPATH**/ ?>