...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Add Value</a>
    </div>
  ...
  <div class="multiple table-responsive" id="listing_data">    
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody id="listing_body" > 
        ...
        ?>
        <tr>
          <td><input type="checkbox" name="selectAll[]" id="chkId<?php echo e($val->DOC_ID); ?>" value="<?php echo e($val->DOC_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->DOC_NO) && $val->DOC_NO !=''?$val->DOC_NO:''); ?></td>
          <td><?php echo e(isset($val->DOC_DATE) && $val->DOC_DATE !=''?$val->DOC_DATE:''); ?></td>

          <td><?php echo e(isset($val->CARD_NO) && $val->CARD_NO !=''?$val->CARD_NO:''); ?></td>
          <td><?php echo e(isset($val->AMOUNT) && $val->AMOUNT !=''?$val->AMOUNT:''); ?></td>
          <td><?php echo e(isset($val->NET_AMOUNT) && $val->NET_AMOUNT !=''?$val->NET_AMOUNT:''); ?></td>
          <td></td>
          <td><?php echo e(isset($val->VALIDITY_MON) && $val->VALIDITY_MON !=''?$val->VALIDITY_MON:''); ?></td>
          <td><?php echo e(isset($val->VALIDITY_TILL) && $val->VALIDITY_TILL !=''?$val->VALIDITY_TILL:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Value Card Print</p></div>
        <div class="row">
...
function getListingData(FRANCHISE_ID){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[$FormId,"getListingData"])); ?>',
    type:'POST',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&DOCID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("master",[532,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("master",[532,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Sales/ValueCardAddValue/mstfrm532.blade.php ENDPATH**/ ?>