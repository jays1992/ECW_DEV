        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              <?php if($objSON->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="PMAL_NO" id="PMAL_NO" value="<?php echo e($objAutoGenNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              <?php endif; ?>
              <?php if($objSON->MANUAL_SR == "1"): ?>
                  <input type="text" name="PMAL_NO" id="PMAL_NO" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
              <?php endif; ?>
            </div>

            <div class="col-lg-2 pl"><p>Doc Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="PMAL_DATE" id="PMAL_DATE" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\PlantMaintenance\Preventive_Maintenance_Actual\trnfrm367add.blade.php ENDPATH**/ ?>