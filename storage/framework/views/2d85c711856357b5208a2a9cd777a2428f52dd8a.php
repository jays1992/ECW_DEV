...
<div class="inner-form">
    <div class="row">
        ...
        <input type="text" name="RCODE" id="RCODE" disabled  class="form-control mandatory" value="<?php echo e(isset($objSE->RCODE)?$objSE->RCODE:''); ?>"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
     	</div>
			
			<div class="col-lg-1 pl col-md-offset-1"><p>Description</p></div>
			<div class="col-lg-3 pl">
   
                <input type="text" name="DESCRIPTIONS" id="DESCRIPTIONS" value="<?php echo e(isset($objSE->DESCRIPTIONS)?$objSE->DESCRIPTIONS:''); ?>" disabled class="form-control" autocomplete="off" />
    ...
    <div class="row" style="margin-left: 1px;">
      ...
      <input disabled type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e(isset($objSE->DEACTIVATED) && $objSE->DEACTIVATED == 1 ? "checked" : ""); ?>
      ...
      <div class="col-lg-2 pl">
        <input disabled type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" <?php echo e(isset($objSE->DEACTIVATED) && $objSE->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objSE->DODEACTIVATED) && $objSE->DODEACTIVATED !="" && $objSE->DODEACTIVATED !="1900-01-01" ? $objSE->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  />
      </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/masters/Common/RoleMaster/mstfrm198view.blade.php ENDPATH**/ ?>