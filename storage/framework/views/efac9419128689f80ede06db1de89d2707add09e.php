      ...
      <div class="inner-form" id="Header_Form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            ...
            <input type="text" name="JWRNO" id="JWRNO" value="<?php echo e($objSONO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <?php endif; ?>

            <?php if($objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="JWRNO" id="JWRNO"  class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
          </div>
                              
          <div class="col-lg-2 pl"><p>JWR Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWRDT" id="JWRDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\JobWork\JobWorkReturn\trnfrm360add.blade.php ENDPATH**/ ?>