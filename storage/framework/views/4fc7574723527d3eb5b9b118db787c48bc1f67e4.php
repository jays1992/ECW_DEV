                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <?php elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1"): ?>
                                  <input type="text" name="BOMNO" id="BOMNO"  class="form-control mandatory"  maxlength="<?php echo e(isset($objDD->MANUAL_MAXLENGTH)?$objDD->MANUAL_MAXLENGTH:''); ?>" tabindex="1" autocomplete="off" style="text-transform:uppercase"  />
                                <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Production\BillofMaterial\mstfrm202add.blade.php ENDPATH**/ ?>