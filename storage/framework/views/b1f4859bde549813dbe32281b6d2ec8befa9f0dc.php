	...
	<div class="inner-form">
        ...
        <?php if(!empty($objDDNO)): ?>
            <?php if($objDDNO->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="DPP_NO" id="DPP_NO" value="<?php echo e($objDPDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus required>
            <?php endif; ?>
            <?php if($objDDNO->MANUAL_SR == "1"): ?>
                <input type="text" name="DPP_NO" id="DPP_NO" value="<?php echo e(old('DPP_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objDDNO->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus required>
            <?php endif; ?>
        <?php endif; ?>    
        <span class="text-danger" id="ERROR_DPP_NO"></span> 
            ...
            <input type="date" name="DPPDT" id="DPPDT"  onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
...
function validateForm(){
        ...
        if(jQuery.inArray("false", allblank) !== -1){
          ...
          else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#DPPDT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Production\DailyProductionPlan\trnfrm230add.blade.php ENDPATH**/ ?>