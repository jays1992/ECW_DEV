...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">UDF Master</a></div>
        ...
        <div class="inner-form">
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="VTID_REF_POPUP" id="VTID_REF_POPUP" value="<?php echo e(isset($voucher_details[0]->VOUCHER_TYPE_NAME)?$voucher_details[0]->VOUCHER_TYPE_NAME:''); ?>" class="form-control" readonly autocomplete="off"/>
                    <input type="hidden" name="VTID_REF" id="VTID_REF" value="<?php echo e(isset($voucher_details[0]->VOUCHER_TYPE)?$voucher_details[0]->VOUCHER_TYPE:''); ?>"  />
                </div>
            </div>
        </div>
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                    ...
                    <tr class="participantRow">
                        <td hidden><input  class="form-control" type="hidden" name=<?php echo e("UDFID_".$key); ?> id =<?php echo e("txtID_".$key); ?> maxlength="100" value="<?php echo e($row->UDFID); ?>" autocomplete="off"   ></td>
                        <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name=<?php echo e("LABEL_".$key); ?> id =<?php echo e("txtlabel_".$key); ?> maxlength="100" value="<?php echo e($row->LABEL); ?>"  autocomplete="off" style="text-transform:uppercase" ></td>
                        <td>
                            <select <?php echo e($ActionStatus); ?> class="form-control selvt" name=<?php echo e("VALUETYPE_".$key); ?> id=<?php echo e("drpvalue_".$key); ?> >
                        ...
                        <td><textarea <?php echo e($ActionStatus !=''?'readonly':''); ?> class="form-control w-100" rows="1"  name=<?php echo e("DESCRIPTIONS_".$key); ?> id=<?php echo e("txtdesc_".$key); ?> maxlength="200" autocomplete="off">"<?php echo e($row->DESCRIPTIONS); ?>"</textarea> </td>
                        <td style="text-align:center;" ><input <?php echo e($ActionStatus); ?> type="checkbox" name=<?php echo e("ISMANDATORY_".$key); ?> id=<?php echo e("chkmdtry_".$key); ?>  <?php echo e($row->ISMANDATORY == 1 ? 'checked' : ''); ?>  ></td>
                        <td style="text-align:center;" ><input <?php echo e($ActionStatus); ?> type="checkbox" name=<?php echo e("DEACTIVATED_".$key); ?>  id=<?php echo e("deactive-checkbox_".$key); ?> <?php echo e($row->DEACTIVATED == 1 ? 'checked' : ''); ?> <?php echo e(isset($n) && $n ==1?'disabled':''); ?> ></td>
                        <td style="text-align:center;" ><input <?php echo e($ActionStatus); ?> type="date" name=<?php echo e("DODEACTIVATED_".$key); ?> class="form-control" placeholder="dd/mm/yyyy" id=<?php echo e("decativateddate_".$key); ?> value="<?php echo e(($row->DODEACTIVATED)=='1900-01-01'?'':$row->DODEACTIVATED); ?>" ></td>                    
                        <td align="center" >
                            <button <?php echo e($ActionStatus); ?> class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                            <button <?php echo e($ActionStatus); ?> class="btn remove" title="Delete" data-toggle="tooltip"  <?php echo e(isset($n) && $n ==1?'disabled':''); ?>  ><i class="fa fa-trash" ></i></button>
                        </td>
                    </tr>
                    <?php $n++; ?>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <div class="modal-body">
      ...
      <table id="vt_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        <tbody>
        <?php $__currentLoopData = $voucher_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$VtList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\UDF\mstfrm528edit.blade.php ENDPATH**/ ?>