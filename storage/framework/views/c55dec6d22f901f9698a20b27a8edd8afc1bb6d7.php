            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                    <td><input type="checkbox" name="DATA_ID[<?php echo e($key); ?>]" onClick="GetUserDetails(this.id,this.value,<?php echo e($row->DATA_ID ==$row->DATA_ID_REF?'true':'false'); ?>)" id="RECORDID_<?php echo e($key); ?>" <?php echo e($row->DATA_ID ==$row->DATA_ID_REF?'checked':''); ?> value="<?php echo e($row->DATA_ID); ?>" class="checkbox" ></td>
...
function GetUserDetails(id,value,status){
  if(status ==false){
  ...
  var UserMappingDetail = $.ajax({type: 'POST',
  url:'<?php echo e(route("master",[$FormId,"GetUserDetails"])); ?>',
  async: false,
  dataType: 'json',
  data: {USERID:value,ACTION:"EDIT"},
  done: function(response) {return response;}}).responseText;
  if(UserMappingDetail > 0){
      $("#"+id).prop('checked', false);
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
      $("#AlertMessage").text('Sorry! The user already mapped with the branch hence you can not map in multiple branch.');
      $("#alert").modal('show')
      $("#OkBtn1").focus();
  }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/masters/Common/UserBranchMapping/mstfrm204edit.blade.php ENDPATH**/ ?>