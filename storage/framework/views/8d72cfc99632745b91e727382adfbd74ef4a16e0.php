...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Service Invoice</a></div>
  ...
  <div class="container-fluid purchase-order-view">    
    ...
    <div class="container-fluid filter">
      <div class="inner-form"> 
        ...
        <div class="row">
          <div class="col-lg-1 pl"><p>Service Invoice No*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="hidden"  name="DOC_ID"     id="DOC_ID" value="<?php echo e(isset($HDR->SIID)?$HDR->SIID:''); ?>" >
            <input <?php echo e($ActionStatus); ?> type="text"    name="DOC_NO"  id="DOC_NO"  value="<?php echo e(isset($HDR->SI_NO)?$HDR->SI_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>
                            
          <div class="col-lg-1 pl"><p>Invoice Date*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($HDR->SI_DATE)?$HDR->SI_DATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
          </div>

          <div class="col-lg-1 pl"><p>Job Card No*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text"    name="JOB_NO"   id="JOB_NO" value="<?php echo e(isset($HDR->JOB_NO)?$HDR->JOB_NO:''); ?>"   class="form-control" autocomplete="off" onclick="getJobCard()" readonly >
            <input <?php echo e($ActionStatus); ?> type="hidden"  name="JEID_REF" id="JEID_REF" value="<?php echo e(isset($HDR->JEID_REF)?$HDR->JEID_REF:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Job Card Date</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="JOB_DATE" id="JOB_DATE" value="<?php echo e(isset($HDR->JOB_DATE)?$HDR->JOB_DATE:''); ?>" class="form-control" autocomplete="off" readonly>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="CUSTOMER_NAME" id="CUSTOMER_NAME" value="<?php echo e(isset($HDR->CUSTOMER_NAME)?$HDR->CUSTOMER_NAME:''); ?>" class="form-control" autocomplete="off" readonly>
            <input <?php echo e($ActionStatus); ?> type="hidden" name="CUSTOMER_ID" id="CUSTOMER_ID" value="<?php echo e(isset($HDR->CUSTOMER_ID)?$HDR->CUSTOMER_ID:''); ?>" class="form-control" autocomplete="off" > 
            <input <?php echo e($ActionStatus); ?> type="hidden" name="HSNID_REF" id="HSNID_REF" value="<?php echo e(isset($HDR->HSNID_REF)?$HDR->HSNID_REF:''); ?>" class="form-control" autocomplete="off" > 
          </div>

          <div class="col-lg-1 pl"><p>Mobile No</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="MOBILE_NO" id="MOBILE_NO" value="<?php echo e(isset($HDR->MOBILE_NO)?$HDR->MOBILE_NO:''); ?>" class="form-control" autocomplete="off" placeholder='Mobile No' maxlength="12"  readonly >
          </div>

          <div class="col-lg-1 pl"><p>Address</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="ADDRESS" id="ADDRESS" value="<?php echo e(isset($HDR->ADDRESS)?$HDR->ADDRESS:''); ?>" class="form-control" autocomplete="off" readonly >
          </div>

          <div class="col-lg-1 pl"><p>Landline No</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="LANDLINE_NO" id="LANDLINE_NO" value="<?php echo e(isset($HDR->LANDLINE_NO)?$HDR->LANDLINE_NO:''); ?>" class="form-control" autocomplete="off" readonly >
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 pl"></div>
          <div class="col-lg-1 pl"><p>Package Amount</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_PACKAGE_AMOUNT" id="TOTAL_PACKAGE_AMOUNT" value="<?php echo e(isset($HDR->TOTAL_PACKAGE_AMOUNT)?number_format($HDR->TOTAL_PACKAGE_AMOUNT, 2, '.', ''):''); ?>" class="form-control" autocomplete="off" readonly >
          </div>

          <div class="col-lg-1 pl"><p>Discount Amount</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_DISCOUONT_AMOUNT" id="TOTAL_DISCOUONT_AMOUNT" value="<?php echo e(isset($HDR->TOTAL_DISCOUONT_AMOUNT)?number_format($HDR->TOTAL_DISCOUONT_AMOUNT, 2, '.', ''):''); ?>" class="form-control" autocomplete="off" readonly >
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_TAX_AMOUNT" id="TOTAL_TAX_AMOUNT" value="<?php echo e(isset($HDR->TOTAL_TAX_AMOUNT)?number_format($HDR->TOTAL_TAX_AMOUNT, 2, '.', ''):''); ?>" class="form-control" autocomplete="off" readonly >
          </div>

          <div class="col-lg-1 pl"><p>Net Amount</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_NET_AMOUNT" id="TOTAL_NET_AMOUNT" value="<?php echo e(isset($HDR->TOTAL_NET_AMOUNT)?number_format($HDR->TOTAL_NET_AMOUNT, 2, '.', ''):''); ?>" class="form-control" autocomplete="off" readonly >
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_PAID_AMOUNT" id="TOTAL_PAID_AMOUNT" value="<?php echo e(isset($HDR->TOTAL_PAID_AMOUNT)?number_format($HDR->TOTAL_PAID_AMOUNT, 2, '.', ''):''); ?>" class="form-control" autocomplete="off" readonly >
          </div>
        </div>
              ...
              <div class="table-responsive table-wrapper-scroll-y" style="height:280px;margin-top:10px;" >
                <table class="display nowrap table table-striped table-bordered itemlist w-200" style="height:auto !important;width:50%">
                  ...
                  <tbody id="package_data" >
                    <?php if(isset($PKG) && !empty($PKG)): ?>
                    <?php $__currentLoopData = $PKG; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="participantRow">
                      <td style="text-align:center;"><?php echo e($key+1); ?></td>
                      <td><input        type="text" name="PACKAGE_NAME[]" id="PACKAGE_NAME_<?php echo e($key); ?>" value="<?php echo e(isset($row->PACKAGE_NAME)?$row->PACKAGE_NAME:''); ?>"  class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?>  /></td>
                      <td hidden><input type="text" name="PACKAGE_ID[]"   id="PACKAGE_ID_<?php echo e($key); ?>"   value="<?php echo e(isset($row->PACKAGE_ID)?$row->PACKAGE_ID:''); ?>"      class="form-control"  autocomplete="off" <?php echo e($ActionStatus); ?> /></td>
                      <td><input        type="text" name="AMOUNT[]"       id="AMOUNT_<?php echo e($key); ?>"       value="<?php echo e(isset($row->AMOUNT)?$row->AMOUNT:''); ?>"              class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    </tr>
                ...
                <thead>
                  <tr>
                    ...
                    <th>Action</th>
							  ...
							  <tbody>
                  <?php if(isset($DIS) && !empty($DIS)): ?>
                  <?php $__currentLoopData = $DIS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr class="discountRow">
                    <td><input        type="text" name="DISCOUNT_NAME[]"    id="DISCOUNT_NAME_<?php echo e($key); ?>"   value="<?php echo e(isset($row->DISCOUNT_NAME)?$row->DISCOUNT_NAME:''); ?>"     class="form-control"  autocomplete="off"  onclick="getDiscountMaster(this.id)" readonly <?php echo e($ActionStatus); ?>  /></td>
                    <td hidden><input type="text" name="DISID_REF[]"        id="DISID_REF_<?php echo e($key); ?>"       value="<?php echo e(isset($row->DISID_REF)?$row->DISID_REF:''); ?>"             class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text" name="DISCOUNT_TYPE[]"    id="DISCOUNT_TYPE_<?php echo e($key); ?>"   value="<?php echo e(isset($row->DISCOUNT_TYPE)?$row->DISCOUNT_TYPE:''); ?>"     class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text" name="DISCOUNT_VALUE[]"   id="DISCOUNT_VALUE_<?php echo e($key); ?>"  value="<?php echo e(isset($row->DISCOUNT_VALUE)?$row->DISCOUNT_VALUE:''); ?>"   class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text" name="DISCOUNT_AMOUNT[]"  id="DISCOUNT_AMOUNT_<?php echo e($key); ?>" value="<?php echo e(isset($row->DISCOUNT_AMOUNT)?$row->DISCOUNT_AMOUNT:''); ?>" class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td align="center" >
                  ...
                  <?php else: ?>
                  <tr class="discountRow">
                    <td><input        type="text" name="DISCOUNT_NAME[]"    id="DISCOUNT_NAME_0"    class="form-control"  autocomplete="off"  onclick="getDiscountMaster(this.id)" readonly <?php echo e($ActionStatus); ?>  /></td>
                    <td hidden><input type="text" name="DISID_REF[]"        id="DISID_REF_0"        class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text" name="DISCOUNT_TYPE[]"    id="DISCOUNT_TYPE_0"    class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text" name="DISCOUNT_VALUE[]"   id="DISCOUNT_VALUE_0"   class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td><input        type="text" name="DISCOUNT_AMOUNT[]"  id="DISCOUNT_AMOUNT_0"  class="form-control"  autocomplete="off" readonly <?php echo e($ActionStatus); ?> /></td>
                    <td align="center" >
                      <button class="btn add material" title="add" data-toggle="tooltip" type="button" <?php echo e($ActionStatus); ?> ><i class="fa fa-plus"></i></button>
                      <button class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button" <?php echo e($ActionStatus); ?> ><i class="fa fa-trash" ></i></button>
                    </td>
...
function getJobCard(){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"getJobCard"])); ?>',
    type:'POST',
...
function loadPackage(JEID_REF){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"loadPackage"])); ?>',
    type:'POST',
...
function getDiscountMaster(textid){
  ...
  if($("#TOTAL_PACKAGE_AMOUNT").val() ===""){
    ...
    $.ajax({
      url:'<?php echo e(route("transaction",[$FormId,"getDiscountMaster"])); ?>',
      type:'POST',
      success:function(data) {
        var html = '';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\sales\ServiceInvoice\trnfrm542view.blade.php ENDPATH**/ ?>