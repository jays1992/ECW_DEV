...
?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="IPO_DT" id="IPO_DT" value="<?php echo e($objHDR->IPO_DT); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" <?php echo e($objHDR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      
      <div class="col-lg-2 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >
          <?php if(count($objsocurrency) > 0): ?>
          <input <?php echo e($ActionStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e($objsocurrency[0]); ?>" readonly   />
          <?php else: ?>
          <input <?php echo e($ActionStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
          <?php endif; ?>
      ...
      <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e($objHDR->CONV_FACTOR); ?>" />
      </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtsubgl_popup" value="<?php echo e($objsubglcode->SGLCODE); ?>-<?php echo e($objsubglcode->SLNAME); ?>" class="form-control mandatory"   autocomplete="off" readonly/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\ImportPurchaseOrder\trnfrm299view.blade.php ENDPATH**/ ?>