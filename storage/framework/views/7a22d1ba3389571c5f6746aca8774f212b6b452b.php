         ...
         <form id="frm_mst_edit" method="POST"  enctype="multipart/form-data" > 
          ...
          <div class="inner-form">
              ...
              <div class="row">
                ...
                <textarea name="ADDL1" id="ADDL1" class="form-control mandatory"  maxlength="200" tabindex="6" style='height:33px;' ><?php echo e(isset($objResponse->ADDL1) && $objResponse->ADDL1 !=""?$objResponse->ADDL1:''); ?></textarea>
                ...
                <div class="col-lg-2 pl">
                <textarea name="ADDL2" id="ADDL2" class="form-control"  maxlength="200" tabindex="6" style='height:33px;' ><?php echo e(isset($objResponse->ADDL2) && $objResponse->ADDL2 !=""?$objResponse->ADDL2:''); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Common\BranchMaster\mstfrm147edit.blade.php ENDPATH**/ ?>