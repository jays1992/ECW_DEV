      ...
      <div class="inner-form">         
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="hidden"  name="DOC_ID"     id="DOC_ID" value="<?php echo e(isset($HDR->JEID)?$HDR->JEID:''); ?>" >
              <input <?php echo e($ActionStatus); ?> type="text"    name="DOC_NO"  id="DOC_NO"  value="<?php echo e(isset($HDR->JOB_NO)?$HDR->JOB_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            </div>
                            
          <div class="col-lg-1 pl"><p>Job Date*</p></div>
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($HDR->JOB_DATE)?$HDR->JOB_DATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
            </div>

          <div class="col-lg-1 pl"><p>Exist Customer</p></div>
          <div class="col-lg-1 pl"> 
            <input <?php echo e($ActionStatus); ?> type="radio" name="CUSTOMER_TYPE" value="EXIST" <?php echo e(isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='EXIST'?'checked':''); ?> onchange="get_customer_type(this.value)" >
          </div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-1 pl"> 
            <input <?php echo e($ActionStatus); ?> type="radio" name="CUSTOMER_TYPE" value="NEW" <?php echo e(isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='NEW'?'checked':''); ?> onchange="get_customer_type(this.value)" >
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" id="SEARCH_CUSTOMER" onkeyup="searchItem(event)" class="form-control" autocomplete="off" placeholder='Mobile No' onkeypress="return isNumberKey(event,this)" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="date" name="DOB" id="DOB" value="<?php echo e(isset($HDR->DOB)?$HDR->DOB:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>E-Mail Id*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="EMAIL_ID" id="EMAIL_ID" value="<?php echo e(isset($HDR->EMAIL_ID)?$HDR->EMAIL_ID:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Mobile No*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="MOBILE_NO" id="MOBILE_NO" value="<?php echo e(isset($HDR->MOBILE_NO)?$HDR->MOBILE_NO:''); ?>" class="form-control" autocomplete="off" placeholder='Mobile No' maxlength="12"  onkeypress="return isNumberKey(event,this)" >
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="ADDRESS" id="ADDRESS" value="<?php echo e(isset($HDR->ADDRESS)?$HDR->ADDRESS:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Anniversary Date</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="date" name="ANNIVERSARY_DATE" id="ANNIVERSARY_DATE" value="<?php echo e(isset($HDR->ANNIVERSARY_DATE)?$HDR->ANNIVERSARY_DATE:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-1 pl"><p>Country*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="COUNTRY_NAME" id="COUNTRY_NAME" value="<?php echo e(isset($HDR->COUNTRY_NAME)?$HDR->COUNTRY_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getCountryMaster()" readonly >
            <input <?php echo e($ActionStatus); ?> type="hidden" name="COUNTRY_ID" id="COUNTRY_ID" value="<?php echo e(isset($HDR->COUNTRY_ID)?$HDR->COUNTRY_ID:''); ?>" class="form-control" autocomplete="off">
          </div>
        
          <div class="col-lg-1 pl"><p>State*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="STATE_NAME" id="STATE_NAME" value="<?php echo e(isset($HDR->STATE_NAME)?$HDR->STATE_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getStateMaster()" readonly >
            <input <?php echo e($ActionStatus); ?> type="hidden" name="STATE_ID" id="STATE_ID" value="<?php echo e(isset($HDR->STATE_ID)?$HDR->STATE_ID:''); ?>" class="form-control" autocomplete="off">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="CITY_NAME" id="CITY_NAME" value="<?php echo e(isset($HDR->CITY_NAME)?$HDR->CITY_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getCityMaster()" readonly >
            <input <?php echo e($ActionStatus); ?> type="hidden" name="CITY_ID" id="CITY_ID" value="<?php echo e(isset($HDR->CITY_ID)?$HDR->CITY_ID:''); ?>" class="form-control" autocomplete="off">
          </div>

          <div class="col-lg-1 pl"><p>Pin Code*</p></div>
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="text" name="PINCODE" id="PINCODE" value="<?php echo e(isset($HDR->PINCODE)?$HDR->PINCODE:''); ?>" class="form-control" autocomplete="off" maxlength="6" onkeypress="return isNumberKey(event,this)" >
          </div>

          <div class="col-lg-1 pl"><p>GST Type*</p></div>
          <div class="col-lg-2 pl"> 
            <select <?php echo e($ActionStatus); ?> name="GST_TYPE" id="GST_TYPE" class="form-control mandatory" autocomplete="off" >
          ...
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="text" name="GST_IN" id="GST_IN" value="<?php echo e(isset($HDR->GST_IN)?$HDR->GST_IN:''); ?>" class="form-control" autocomplete="off">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="text" name="LANDLINE_NO" id="LANDLINE_NO" value="<?php echo e(isset($HDR->LANDLINE_NO)?$HDR->LANDLINE_NO:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberKey(event,this)" >
          </div>

          <div class="col-lg-1 pl"><p>Vehicle Reg No*</p></div>
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="text" name="VEHICLE_REG_NO" id="VEHICLE_REG_NO" value="<?php echo e(isset($HDR->VEHICLE_REG_NO)?$HDR->VEHICLE_REG_NO:''); ?>" class="form-control" autocomplete="off">
          </div>
        
          <div class="col-lg-1 pl"><p>Vehicle Make*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="text" name="VEHICLE_MAKE_NAME" id="VEHICLE_MAKE_NAME" value="<?php echo e(isset($HDR->VEHICLE_MAKE_NAME)?$HDR->VEHICLE_MAKE_NAME:''); ?>" class="form-control" autocomplete="off" onclick="getVehicleMakeMaster()" readonly >
            <input <?php echo e($ActionStatus); ?> type="hidden" name="VEHICLE_MAKE_ID" id="VEHICLE_MAKE_ID" value="<?php echo e(isset($HDR->VEHICLE_MAKE_ID)?$HDR->VEHICLE_MAKE_ID:''); ?>" class="form-control" autocomplete="off">
          </div>

          <div class="col-lg-1 pl"><p>Registration Year*</p></div>
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="text" name="REG_YEAR" id="REG_YEAR" value="<?php echo e(isset($HDR->REG_YEAR)?$HDR->REG_YEAR:''); ?>" class="form-control" autocomplete="off" maxlength="4" onkeypress="return isNumberKey(event,this)">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="text" name="SUPERVISOR_NAME" id="SUPERVISOR_NAME" value="<?php echo e(isset($HDR->SUPERVISOR_NAME)?$HDR->SUPERVISOR_NAME:''); ?>" class="form-control" autocomplete="off">
          </div>

          <div class="col-lg-1 pl"><p>In Time*</p></div>
          <div class="col-lg-2 pl"> 
          <input <?php echo e($ActionStatus); ?> type="time" name="IN_TIME" id="IN_TIME" value="<?php echo e(isset($HDR->IN_TIME)?$HDR->IN_TIME:''); ?>" class="form-control" autocomplete="off" >
          </div>
        
          <div class="col-lg-1 pl"><p>OUT Time*</p></div>
          <div class="col-lg-2 pl"> 
            <input <?php echo e($ActionStatus); ?> type="time" name="OUT_TIME" id="OUT_TIME" value="<?php echo e(isset($HDR->OUT_TIME)?$HDR->OUT_TIME:''); ?>" class="form-control" autocomplete="off" >
          </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" style="height:auto !important;width:50%">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="PACKAGE_NAME[]" id="PACKAGE_NAME_<?php echo e($key); ?>" value="<?php echo e(isset($row->PACKAGE_NAME)?$row->PACKAGE_NAME:''); ?>"   class="form-control"  autocomplete="off" onclick="getPackageMaster(this.id)" readonly  /></td>
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="PACKAGE_ID[]" id="PACKAGE_ID_<?php echo e($key); ?>" value="<?php echo e(isset($row->PAMID_REF)?$row->PAMID_REF:''); ?>"  class="form-control"  autocomplete="off" /></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="AMOUNT[]" id="AMOUNT_<?php echo e($key); ?>"  value="<?php echo e(isset($row->AMOUNT)?$row->AMOUNT:''); ?>" onkeypress="return isNumberDecimalKey(event,this)" onkeyup="get_total_amount()" class="form-control"  autocomplete="off" /></td>
                      <td align="center" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\sales\JobEstimation\trnfrm538edit.blade.php ENDPATH**/ ?>