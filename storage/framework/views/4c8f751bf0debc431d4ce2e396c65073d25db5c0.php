        ...
        <div class="container-fluid filter">
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                            ...
                            <?php if(isset($objSTSTN->SYSTEM_GRSR) && $objSTSTN->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="DOCNO" id="DOCNO" value="<?php echo e(isset($objSTSNO)?$objSTSNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            
                            <?php elseif(isset($objSTSTN->MANUAL_SR) && $objSTSTN->MANUAL_SR == "1"): ?>
                                <input type="text" name="DOCNO" id="DOCNO" value="<?php echo e(old('STSNO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSQN->MANUAL_MAXLENGTH)?$objSQN->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                                <?php else: ?>
                    ...
                    <input type="hidden" id="objlastSTSDT"  value="<?php echo e($objlastSTSDT[0]->STTOST_DOCDT); ?>">
                                <input type="date" name="STSDT" id="STSDT" onchange="checkPeriodClosing(270,this.value,1)" value="<?php echo e(old('STSDT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\inventory\StoretoStoreTransafer\trnfrm270add.blade.php ENDPATH**/ ?>