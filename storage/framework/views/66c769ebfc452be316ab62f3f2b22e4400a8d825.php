...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Master</a>
    </div>
    ...
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody id="listing_body" > 
        ...
        <tr>
          ...
          <td><?php echo e(isset($val->DISCOUNT_PERCENT) && $val->DISCOUNT_PERCENT !=''?$val->DISCOUNT_PERCENT:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/ValueCardMaster/mstfrm531.blade.php ENDPATH**/ ?>