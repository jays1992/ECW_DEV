...
<div class="container-fluid topnav">
	<div class="row">
		<div class="col-lg-2"><a href="<?php echo e(route('master',[526,'index'])); ?>" class="btn singlebt">Price List Standard Master</a></div>
	...
	<form id="form_data" method="POST" onsubmit="return false;" > 
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <label><?php echo e($objMstResponse->PLCODE); ?></label>
        </div>	
        <div class="col-lg-1 pl"><p>Price Level Name</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="PLCID_REF_POPUP" id="PLCID_REF_POPUP" class="form-control mandatory" value="<?php echo e($objMstResponse->PLNAME); ?>" required readonly tabindex="3" />
        </div>
        <div class="col-lg-2 pl"><p>Remarks</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="PLCID_REF_POPUP" id="PLCID_REF_POPUP" class="form-control mandatory" value="<?php echo e($objMstResponse->REMARKS); ?>" required readonly tabindex="3" />
        </div>
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\PriceLevel\mstfrm526view.blade.php ENDPATH**/ ?>