...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->KNOWOFFID); ?>" value="<?php echo e($val->KNOWOFFID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->KNOCKOFF_DT) && $val->KNOCKOFF_DT !='' && $val->KNOCKOFF_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->KNOCKOFF_DT)):''); ?>" ></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\inventory\KnowkOff\trnfrm313.blade.php ENDPATH**/ ?>