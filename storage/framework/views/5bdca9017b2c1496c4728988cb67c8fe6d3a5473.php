<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[526,'index'])); ?>" class="btn singlebt">Price List Standard Master</a>
                </div><!--col-2-->
                        ...
                        <div class="row">                            
                            <div class="col-lg-2 pl"><p>Price Level Code </p></div>
                                ...
                                <div class="col-lg-2 pl">
                                  <input type="text" name="PLCODE" id="PLCODE" value="<?php echo e(isset($objMstResponse->PLCODE)?$objMstResponse->PLCODE:''); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" />
                                      <span class="text-danger" id="ERROR_PLCODE"></span> 
                                </div>
                            <div class="col-lg-2 pl"><p>Price Level Name</p></div>
                                <div class="col-lg-2 pl">
                                  <input type="text" name="PLNAME" id="PLNAME" class="form-control mandatory" value="<?php echo e(isset($objMstResponse->PLNAME)?$objMstResponse->PLNAME:''); ?>" maxlength="200" tabindex="2"  />
                                    <span class="text-danger" id="ERROR_PLNAME"></span> 
                                </div>
                            <div class="col-lg-2 pl"><p>Remarks</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($objMstResponse->REMARKS)?$objMstResponse->REMARKS:''); ?>" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>                            
                        </div>
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                              ...
                                              <tr  class="participantRow4">
                                                ...
                                                <td hidden>
                                                  <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' value="<?php echo e($udfrow->UDFID); ?>" class="form-control" maxlength="100" />
                                                </td>
...
$(document).ready(function(e) {
    ...
    $('#btnAdd').on('click', function() {
        var viewURL = '<?php echo e(route("master",[526,"add"])); ?>';
...
//SO Validity to Date Check
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[526,'add'])); ?>";
...
window.fnApproveData = function (){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[526,"singleapprove"])); ?>',
        type:'POST',
        data:formData,
...
// fnUpdateDataStart
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[526,"update"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("master",[526,"index"])); ?>';
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\PriceLevel\mstfrm526edit.blade.php ENDPATH**/ ?>