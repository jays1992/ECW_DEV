      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <?php if($objSON->SYSTEM_GRSR == "1"): ?>
            <input type="text" name="SALARY_STRUC_NO" id="SALARY_STRUC_NO" value="<?php echo e($objAutoGenNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
          <?php endif; ?>
          <?php if($objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="SALARY_STRUC_NO" id="SALARY_STRUC_NO" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" >
          <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Payroll\SalaryStructureMaster\mstfrm197add.blade.php ENDPATH**/ ?>