          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="password" name="PASSWORD" id="PASSWORD" class="form-control mandatory" value="<?php echo e(old('PASSWORD',$objResponse->PASSWORD)); ?>" maxlength="200" tabindex="3" disabled />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="password" name="CONFIRM_PASSWORD" id="CONFORM_PASSWORD" class="form-control mandatory" value="<?php echo e(old('CONFORM_PASSWORD',$objResponse->PASSWORD)); ?>"  maxlength="200" tabindex="4"  disabled/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Common\UserMaster\mstfrm150view.blade.php ENDPATH**/ ?>