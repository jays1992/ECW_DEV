                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                      ...
                      <input type="text" name="EMPLOYEE_TARGETCODE" id="EMPLOYEE_TARGETCODE" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                    <?php elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1"): ?>
                      <input type="text" name="EMPLOYEE_TARGETCODE" id="EMPLOYEE_TARGETCODE" value="<?php echo e(old('EMPLOYEE_TARGETCODE')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objDD->MANUAL_MAXLENGTH)?$objDD->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                    <?php else: ?>
                      <input type="text" name="EMPLOYEE_TARGETCODE" id="EMPLOYEE_TARGETCODE" value="<?php echo e(old('EMPLOYEE_TARGETCODE')); ?>"  class="form-control mandatory"  autocomplete="off" style="text-transform:uppercase"  >
                      <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\PreSales\EmployeeTargetMaster\mstfrm435add.blade.php ENDPATH**/ ?>