...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">UDF Master</a>
    </div>
  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->UDFID); ?>" value="<?php echo e($val->UDFID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->VOUCHER_TYPE_NAME) && $val->VOUCHER_TYPE_NAME !=''?strtoupper($val->VOUCHER_TYPE_NAME):''); ?></td>
          <td><?php echo e(isset($val->LABEL) && $val->LABEL !=''?strtoupper($val->LABEL):''); ?></td>
          <td><?php echo e(isset($val->VALUETYPE) && $val->VALUETYPE !=''?$val->VALUETYPE:''); ?></td>
          <td><?php echo e(isset($val->DESCRIPTIONS) && $val->DESCRIPTIONS !=''?$val->DESCRIPTIONS:''); ?></td>
          <td><?php echo e(isset($val->ISMANDATORY) && $val->ISMANDATORY !='' && $val->ISMANDATORY =='1'?'Yes':'No'); ?></td>
          <td><?php echo e(isset($val->DEACTIVATED) && $val->DEACTIVATED !='' && $val->DEACTIVATED =='1'?'Yes':'No'); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\UDF\mstfrm528.blade.php ENDPATH**/ ?>