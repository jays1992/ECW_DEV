        ...
        <div class="container-fluid filter">
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                            ...
                            <?php if(isset($objPSENO->SYSTEM_GRSR) && $objPSENO->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="DOCNO" id="DOCNO" value="<?php echo e(isset($objPSENOS)?$objPSENOS:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            
                            <?php elseif(isset($objPSENO->MANUAL_SR) && $objPSENO->MANUAL_SR == "1"): ?>
             ...
             <div class="col-lg-2 pl"><p>Date</p></div>
                <div class="col-lg-2 pl">
                    ...
                    <input type="date" name="PSEDT" id="PSEDT" onchange="checkPeriodClosing(311,this.value,1)" value="<?php echo e(old('PSEDT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
           </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\inventory\PhysicalStockEntry\trnfrm311add.blade.php ENDPATH**/ ?>