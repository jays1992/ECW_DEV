...
<div class="container-fluid topnav">
  <div class="row">
    ...
    <div class="col-lg-10 topnav-pd">
      <a href="<?php echo e(route('master',[48,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e($objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/purchase/vendormaster/mstfrm48.blade.php ENDPATH**/ ?>