        ...
        <div class="multiple table-responsive  ">
            ...
            <?php
             $DataStatus= isset($val->STATUS_DESC) && $val->STATUS_DESC!='' ? $val->STATUS_DESC : '';
              ...
              ?>
              <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->SQID); ?>" value="<?php echo e($val->SQID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SQDT) && $val->SQDT !='' && $val->SQDT !='1900-01-01' ? date('d-m-Y',strtotime($val->SQDT)):''); ?>" ></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesQuotation\trnfrm36.blade.php ENDPATH**/ ?>