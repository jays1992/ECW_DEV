            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="card o-hidden border-0 shadow-lg">
                            ...
                            <div class="row">
                                  <div class="col-lg-12">
                                    <div class="p-5">
                                          ...
                                          <h3 class="form-title"><img class="imgyrls" src="<?php echo e(asset('img/white-logo1.png')); ?>"  /></h3>
                        ...
                        <input id="UCODE" type="text" class="form-control form-control-user control" name="UCODE" value="<?php echo e(old('UCODE')); ?>" autocomplete="off" placeholder="User ID" onfocusout="getCompany()" tabindex="1" >
                        ...
                        <input id="PASSWORD" type="PASSWORD" class="form-control form-control-user control <?php $__errorArgs = ['PASSWORD'];
...
<?php /**PATH C:\xampp\htdocs\PROJECTS\ECW_DEV\resources\views/auth/login.blade.php ENDPATH**/ ?>