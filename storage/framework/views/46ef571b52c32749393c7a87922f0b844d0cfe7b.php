...
<?php $helper = app('App\Helpers\Helper'); ?> 
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              <?php if(isset($objPAYDOCNO->SYSTEM_GRSR) && $objPAYDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="PAYMENT_NO" id="PAYMENT_NO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              <?php elseif(isset($objPAYDOCNO->MANUAL_SR) && $objPAYDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="PAYMENT_NO" id="PAYMENT_NO" value="<?php echo e(old('PAYMENT_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objPBDOCNO->MANUAL_MAXLENGTH)?$objPBDOCNO->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
            <?php else: ?>
                <input type="text" name="PAYMENT_NO" id="PAYMENT_NO" value="<?php echo e(old('PAYMENT_NO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
            <?php endif; ?>
        </div>
        <div class="col-lg-1 pl"><p>Payment Date*</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PAYMENT_DT" id="PAYMENT_DT" value="<?php echo e(old('PAYMENT_DT')); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\PaymentEntry\trnfrm301add.blade.php ENDPATH**/ ?>