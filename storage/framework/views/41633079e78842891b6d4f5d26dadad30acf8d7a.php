...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Amount Master</a>
    </div>
    ...
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        <tr>
          ...
          <td><?php echo e(isset($val->VCA_AMT) && $val->VCA_AMT !=''?$val->VCA_AMT:''); ?></td>
          <td><?php echo e(isset($val->DIS_PERCENT) && $val->DIS_PERCENT !=''?$val->DIS_PERCENT:''); ?></td>
          <td><?php echo e(isset($val->PERCENTAGE_AMT) && $val->PERCENTAGE_AMT !=''?$val->PERCENTAGE_AMT:''); ?></td>
          <td><?php echo e(isset($val->CARDVALIDITY_MON) && $val->CARDVALIDITY_MON !=''?$val->CARDVALIDITY_MON:''); ?></td>
          <td><?php echo e(isset($val->TOTAL_AMT) && $val->TOTAL_AMT !=''?$val->TOTAL_AMT:''); ?></td>
          <td><?php echo e(isset($val->DEACTIVATED) && $val->DEACTIVATED !='' && $val->DEACTIVATED =='1'?'No':'Yes'); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/ValueCardAmountMaster/mstfrm529.blade.php ENDPATH**/ ?>