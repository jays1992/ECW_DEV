  ...
  <div class="container-fluid filter">
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="date" name="FD_DATE" id="FD_DATE" value="<?php echo e(isset($HDR->FD_DATE)?$HDR->FD_DATE:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="date" name="MATURITY_DATE" id="MATURITY_DATE" value="<?php echo e(isset($HDR->MATURITY_DATE)?$HDR->MATURITY_DATE:''); ?>" class="form-control" autocomplete="off" />
        </div>
        
        <div class="col-lg-2 pl"><p>In-Favour</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="IN_FAVOUR" id="IN_FAVOUR" value="<?php echo e(isset($HDR->IN_FAVOUR)?$HDR->IN_FAVOUR:''); ?>" class="form-control" autocomplete="off" />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="BG_NO" id="BG_NO" value="<?php echo e(isset($HDR->BG_NO)?$HDR->BG_NO:''); ?>" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Principal Amount</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="PRINCIPLE_AMOUNT" id="PRINCIPLE_AMOUNT" value="<?php echo e(isset($HDR->PRINCIPLE_AMOUNT)?$HDR->PRINCIPLE_AMOUNT:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" />
        </div>
      </div>  
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="RATE_OF_INTEREST" id="RATE_OF_INTEREST" value="<?php echo e(isset($HDR->RATE_OF_INTEREST)?$HDR->RATE_OF_INTEREST:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" />
        </div>
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Maturity Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="PRE_MATURITY_DATE" id="PRE_MATURITY_DATE" value="<?php echo e(isset($HDR->PRE_MATURITY_DATE)?$HDR->PRE_MATURITY_DATE:''); ?>" class="form-control" autocomplete="off" onchange="getMatureType()" />
        </div>

        <div class="col-lg-2 pl"><p>Interest calculator</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="INTEREST_CALCULATOR" id="INTEREST_CALCULATOR" value="<?php echo e(isset($HDR->INTEREST_CALCULATOR)?$HDR->INTEREST_CALCULATOR:''); ?>" class="form-control" autocomplete="off" onkeyup="getGrossFdValue()" />
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\Accounts\FixedDeposit\trnfrm501mature.blade.php ENDPATH**/ ?>