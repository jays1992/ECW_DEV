            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="SIDT" id="SIDT" value="<?php echo e(isset($objSI->SIDT)?$objSI->SIDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" format="mm/dd/yyyy" />
                            </div>                               
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" <?php echo e(isset($objSI->SIFC) && $objSI->SIFC == 1 ? 'checked' : ''); ?> >
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="divcurrency" >
                                ...
                                <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objsocurrency[0])?$objsocurrency[0]:''); ?>" readonly   />
                                <?php else: ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
                                <?php endif; ?>
                                <input <?php echo e($InputStatus); ?> type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objSI->CRID_REF)?$objSI->CRID_REF:''); ?>" />
                                
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSI->CONVFACT)?$objSI->CONVFACT:''); ?>" <?php echo e(isset($objSI->SIFC) && $objSI->SIFC  == 1 ? 'readonly' : 'disabled'); ?> />
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesInvoice - Copy\trnfrm44edit.blade.php ENDPATH**/ ?>