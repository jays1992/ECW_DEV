...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="date" name="PII_DT" id="PII_DT" value="<?php echo e(isset($objHDR->PII_DT)?$objHDR->PII_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" <?php echo e(isset($objHDR->FC) && $objHDR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      
      <div class="col-lg-2 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >
          <?php if( isset($objsocurrency) && count($objsocurrency) > 0): ?>
          <input <?php echo e($ActionStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objsocurrency[0])?$objsocurrency[0]:''); ?>" readonly   />
          <?php else: ?>
      ...
      <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objHDR->CONV_FACTOR)?$objHDR->CONV_FACTOR:''); ?>" />
      </div>
  </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\PurchaseInvoiceImport\trnfrm300view.blade.php ENDPATH**/ ?>