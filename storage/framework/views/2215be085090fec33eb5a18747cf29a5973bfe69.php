  ...
  <div class="row">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="<?php echo e(asset('img/1slider.jpg')); ?>" alt="Express Car wash" style="width:100%;">
      </div>

      <div class="item">
        <img src="<?php echo e(asset('img/2slider.jpg')); ?>" alt="Express Car wash" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="<?php echo e(asset('img/3slider.jpg')); ?>" alt="Express Car wash" style="width:100%;">
      </div>
    </div>
...
<div class="row" style="display:none">
    ...
    <div class="col-lg-3">
        <div class="home-box box-color4"  style="cursor:pointer;" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECTS\ECW_DEV\resources\views/home.blade.php ENDPATH**/ ?>