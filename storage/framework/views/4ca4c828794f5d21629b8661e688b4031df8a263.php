                  ...
                  <div class="col-lg-2 pl">
                    <?php if(!empty($objDDNO)): ?>
                        <?php if($objDDNO->SYSTEM_GRSR == "1"): ?>
                            <input type="text" name="LEAVE_APP_NO" id="LEAVE_APP_NO" value="<?php echo e($objDPDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus required>
                        <?php endif; ?>
                        <?php if($objDDNO->MANUAL_SR == "1"): ?>
                            <input type="text" name="LEAVE_APP_NO" id="LEAVE_APP_NO" value="<?php echo e(old('LEAVE_APP_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objDDNO->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus required>
                        <?php endif; ?>
                    <?php endif; ?>    
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Payroll\LeaveApply\trnfrm402add.blade.php ENDPATH**/ ?>