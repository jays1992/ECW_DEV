        ...
        <div class="col-lg-2 pl">
            <?php if($objPBDOCNO): ?>
              <?php if($objPBDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="IPO_NO" id="IPO_NO" value="<?php echo e($objDataNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              <?php endif; ?>
              <?php if($objPBDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="IPO_NO" id="IPO_NO" value="<?php echo e(old('IPO_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objPBDOCNO->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
              <?php endif; ?>
            <?php else: ?>
                <input type="text" name="IPO_NO" id="IPO_NO" value="<?php echo e(old('IPO_NO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="IPO_DT" id="IPO_DT" value="<?php echo e(old('IPO_DT')); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\ImportPurchaseOrder\trnfrm299add.blade.php ENDPATH**/ ?>