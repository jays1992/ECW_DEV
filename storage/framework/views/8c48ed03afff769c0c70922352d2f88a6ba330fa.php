                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl"><p>Franchise*</p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="FR_popup" id="txtfr_popup" class="form-control mandatory" value="<?php echo e($objBRANCH->BRCODE.'-'.$objBRANCH->BRNAME); ?>" autocomplete="off" readonly/>
                            <input type="hidden" name="BRID_REF" id="BRID_REF" class="form-control" autocomplete="off"  value="<?php echo e($objBRANCH->BRID); ?>"/>
...
<!-- Franchise Dropdown -->
<div id="fridpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" id='fr_closePopup' >&times;</button>
      </div>
    <div class="modal-body">
	  <div class="tablename"><p>Franchise</p></div>
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
    <table id="FRCodeTable" class="display nowrap table  table-striped table-bordered" >
    <thead>
    <tr>
      <th class="ROW1">Select</th> 
      <th class="ROW2">Code</th>
    ...
    <tr>
        <th class="ROW1"><span class="check_th">&#10004;</span></th>
        <td class="ROW2"><input type="text" id="frcodesearch" class="form-control" autocomplete="off" onkeyup="FRCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="frnamesearch" class="form-control" autocomplete="off" onkeyup="FRNameFunction()"></td>
      </tr>
    </tbody>
    </table>
      <table id="FRCodeTable2" class="display nowrap table  table-striped table-bordered" >
        <thead id="thead2">
          
        </thead>
        <tbody>
        <?php $__currentLoopData = $Franchise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_BRID_REF[]" id="fridcode_<?php echo e($index); ?>" class="clsfrid" value="<?php echo e($Row-> BRID); ?>" ></td>
          <td class="ROW2"><?php echo e($Row-> BRCODE); ?> <input type="hidden" id="txtfridcode_<?php echo e($index); ?>" data-desc="<?php echo e($Row-> BRCODE); ?>-<?php echo e($Row-> BRNAME); ?>"  value="<?php echo e($Row-> BRID); ?>"/></td>
          <td class="ROW3"><?php echo e($Row-> BRNAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
//------------------------
  ...
  //franchise 
  let frid = "#FRCodeTable2";
      let frid2 = "#FRCodeTable";
      let headers1 = document.querySelectorAll(frid2 + " th");

      // Sort the table element when clicking on the table headers1
      headers1.forEach(function(element, i) {
        element.addEventListener("click", function() {
          w3.sortHTML(frid, ".clsfrid", "td:nth-child(" + (i + 1) + ")");
        });
      });

      function FRCodeFunction() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("frcodesearch");
        filter = input.value.toUpperCase();
        table = document.getElementById("FRCodeTable2");
        tr = table.getElementsByTagName("tr");
        for (i = 0; i < tr.length; i++) {
          td = tr[i].getElementsByTagName("td")[1];
          if (td) {
  ...
  function FRNameFunction() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("frnamesearch");
        filter = input.value.toUpperCase();
        table = document.getElementById("FRCodeTable2");
        tr = table.getElementsByTagName("tr");
        for (i = 0; i < tr.length; i++) {
      ...
      $('#txtfr_popup').focus(function(event){
        showSelectedCheck($("#BRID_REF").val(),"SELECT_BRID_REF");
         $("#fridpopup").show();
         event.preventDefault();
      });

      $("#fr_closePopup").click(function(event){
        $("#fridpopup").hide();
        event.preventDefault();
      });

      $(".clsfrid").click(function(){
        var fieldid = $(this).attr('id');
        var txtval =    $("#txt"+fieldid+"").val();
        var texdesc =   $("#txt"+fieldid+"").data("desc");
        $('#txtfr_popup').val(texdesc);
        $('#BRID_REF').val(txtval);
        $("#fridpopup").hide();
        $("#frcodesearch").val(''); 
        $("#frnamesearch").val('');       
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/transactions/Purchase/PurchaseOrder/trnfrm63add.blade.php ENDPATH**/ ?>