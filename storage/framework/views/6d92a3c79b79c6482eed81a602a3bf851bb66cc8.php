...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Add Value</a></div>
      ...
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="hidden"  name="DOC_ID"     id="DOC_ID" value="<?php echo e(isset($HDR->VCADD_ID)?$HDR->VCADD_ID:''); ?>" >
            <input <?php echo e($ActionStatus); ?> type="text"    name="DOC_NO"  id="DOC_NO"  value="<?php echo e(isset($HDR->VCADD_NO)?$HDR->VCADD_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>

          <div class="col-lg-2 pl"><p>Document Date*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($HDR->VCADD_DATE)?$HDR->VCADD_DATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
          </div>

          <div class="col-lg-2 pl"><p>Franchise Name*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text"   name="BRANCH_NAME" id="BRANCH_NAME" value="<?php echo e(isset($HDR->BRANCH_NAME)?$HDR->BRANCH_NAME:''); ?>"  class="form-control"  autocomplete="off"  readonly/>
            <input type="hidden" name="BRANCH_ID" id="BRANCH_ID" value="<?php echo e(isset($HDR->BRANCH_ID)?$HDR->BRANCH_ID:''); ?>"      class="form-control"  autocomplete="off" />  
          </div>
        </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">
                    <tr>
                      ...
                      <th hidden>Balance Amount</th>
                      <th hidden>Net Amount</th>
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td hidden><input type="text" name="DETAIL_ID[]" id="DETAIL_ID_<?php echo e($key); ?>" value="<?php echo e(isset($row->DETAIL_ID_REF)?$row->DETAIL_ID_REF:''); ?>"     class="form-control"  autocomplete="off" /></td>
                      <td hidden><input type="text" name="AMOUNT_ID[]" id="AMOUNT_ID_<?php echo e($key); ?>" value="<?php echo e(isset($row->AMOUNT_ID)?$row->AMOUNT_ID:''); ?>"    class="form-control"  autocomplete="off" /></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="CARD_NO[]" id="CARD_NO_<?php echo e($key); ?>" value="<?php echo e(isset($row->CARD_NO)?$row->CARD_NO:''); ?>"      class="form-control"  autocomplete="off" maxlength="15" onclick="getCardMaster(this.id)" readonly  /></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="AMOUNT[]" id="AMOUNT_<?php echo e($key); ?>"   value="<?php echo e(isset($row->AMOUNT)?$row->AMOUNT:''); ?>"     class="form-control"  autocomplete="off"   readonly/></td>
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="BALANCE_AMT[]" id="BALANCE_AMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->BALANCE_AMT)?floatval($row->BALANCE_AMT):''); ?>"     class="form-control"  autocomplete="off"  readonly/></td>
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="NET_AMOUNT[]"  id="NET_AMOUNT_<?php echo e($key); ?>" value="<?php echo e(isset($row->NET_AMOUNT)?$row->NET_AMOUNT:''); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="VALIDITY_MON[]" id="VALIDITY_MON_<?php echo e($key); ?>" value="<?php echo e(isset($row->VALIDITY_MON)?$row->VALIDITY_MON:''); ?>"  class="form-control"  autocomplete="off" onkeyup="getValidityDate()" /></td>
                      <td><input <?php echo e($ActionStatus); ?> type="date" name="VALIDITY_TILL[]" id="VALIDITY_TILL_<?php echo e($key); ?>" value="<?php echo e(isset($row->VALIDITY_TILL)?$row->VALIDITY_TILL:''); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="ADD_VALUE[]" id="ADD_VALUE_<?php echo e($key); ?>"  value="<?php echo e(isset($row->ADD_AMOUNT)?$row->ADD_AMOUNT:''); ?>"    class="form-control"  autocomplete="off" /></td>
                      <td align="center" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/masters/Sales/ValueCardAddValue/mstfrm532edit.blade.php ENDPATH**/ ?>