...
<form id="form_data" method="POST" >
  ...
  <div class="inner-form"> 
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" id="SEARCH_CUSTOMER" onkeyup="searchItem1(event)" class="form-control" autocomplete="off" placeholder='Mobile No' onkeypress="return isNumberKey(event,this)" >
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"> 
          <input type="text" name="COUNTRY_NAME" id="COUNTRY_NAME" class="form-control" autocomplete="off" onclick="getCountryMaster()" readonly value="<?php echo e(isset($country_state_city[0]->COUNTRY_NAME)?$country_state_city[0]->COUNTRY_NAME:''); ?>" >
          <input type="hidden" name="COUNTRY_ID" id="COUNTRY_ID" class="form-control" autocomplete="off" value="<?php echo e(isset($country_state_city[0]->COUNTRY_ID)?$country_state_city[0]->COUNTRY_ID:''); ?>" >
        </div>
       
        <div class="col-lg-2 pl"><p>State*</p></div>
        <div class="col-lg-2 pl"> 
          <input type="text" name="STATE_NAME" id="STATE_NAME" class="form-control" autocomplete="off" onclick="getStateMaster()" readonly value="<?php echo e(isset($country_state_city[0]->STATE_NAME)?$country_state_city[0]->STATE_NAME:''); ?>" >
          <input type="hidden" name="STATE_ID" id="STATE_ID" class="form-control" autocomplete="off" value="<?php echo e(isset($country_state_city[0]->STATE_ID)?$country_state_city[0]->STATE_ID:''); ?>" >
        </div>

        <div class="col-lg-2 pl"><p>City*</p></div>
        <div class="col-lg-2 pl"> 
          <input type="text" name="CITY_NAME" id="CITY_NAME" class="form-control" autocomplete="off" onclick="getCityMaster()" readonly value="<?php echo e(isset($country_state_city[0]->CITY_NAME)?$country_state_city[0]->CITY_NAME:''); ?>" >
          <input type="hidden" name="CITY_ID" id="CITY_ID" class="form-control" autocomplete="off" value="<?php echo e(isset($country_state_city[0]->CITY_ID)?$country_state_city[0]->CITY_ID:''); ?>" >
        </div>
      </div>
...
function Get_Balance(textid,value){
  ...
  url:'<?php echo e(route("transaction",[$FormId,"Get_Card_Balance"])); ?>',
  async: false,
  dataType: 'json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/transactions/sales/ValueCardSales/trnfrm543add.blade.php ENDPATH**/ ?>