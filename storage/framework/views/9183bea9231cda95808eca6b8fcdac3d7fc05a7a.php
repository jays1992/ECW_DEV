...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Package Master</a>
    </div>
  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->PKMID); ?>" value="<?php echo e($val->PKMID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->PKMCODE) && $val->PKMCODE !=''?$val->PKMCODE:''); ?></td>
          <td><?php echo e(isset($val->PKMDATE) && $val->PKMDATE !=''?$val->PKMDATE:''); ?></td>
          <td><?php echo e(isset($val->PKMNAME) && $val->PKMNAME !=''?$val->PKMNAME:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/PackageMaster/mstfrm536.blade.php ENDPATH**/ ?>