...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Sales List</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Franchise Name</p></div>
                            <div class="col-lg-3 pl">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="CardStatus[]" data-hide-disabled="hide"  data-actions-box="true" id="CardStatus"  class="form-control selectpicker" data-live-search="true"  >
                                    <?php $__currentLoopData = $objCard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bindex=>$bRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!-- <option value="<?php echo e($bRow->ACTIVE); ?>" selected><?php //if ($bRow->ACTIVE =='0') { echo 'Active'; } else if ($bRow->INACTIVE ==NULL) {echo 'Inactive';} else { echo '';} ?> </option> -->
                                        <option value="<?php echo e($bRow->ACTIVE); ?>" selected><?php if ($bRow->ACTIVE =='0') { echo 'Active'; } ?></option>
                                        <option value="<?php echo e($bRow->INACTIVE); ?>"><?php if ($bRow->INACTIVE ==NULL) { echo 'Inactive'; } ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/reports/purchase/ValueCardSalesList/rptfrm551.blade.php ENDPATH**/ ?>