      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
            <input type="text" name="ENTITLEMENT_NO" id="ENTITLEMENT_NO" value="<?php echo e($objAutoGenNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
          <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="ENTITLEMENT_NO" id="ENTITLEMENT_NO" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" >
          <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Payroll\EntitlementMaster\mstfrm200add.blade.php ENDPATH**/ ?>