...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              <?php if(isset($objARDOCNO->SYSTEM_GRSR) && $objARDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              <?php elseif(isset($objARDOCNO->MANUAL_SR) && $objARDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="<?php echo e(old('AR_DOC_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objARDOCNO->MANUAL_MAXLENGTH)?$objARDOCNO->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
            <?php else: ?>
                <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="<?php echo e(old('AR_DOC_NO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
            <?php endif; ?>
        </div>
        <div class="col-lg-2 pl"><p>Debit/Credit Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="AR_DOC_DT" id="AR_DOC_DT" value="<?php echo e(old('AR_DOC_DT')); ?>" onchange="checkPeriodClosing(233,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\ARDebitNote\trnfrm233add.blade.php ENDPATH**/ ?>