...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Package Master</a></div>
    ...
    <div class="inner-form">         
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="hidden"  name="DOC_ID"     id="DOC_ID" value="<?php echo e(isset($HDR->PKMID)?$HDR->PKMID:''); ?>" >
          <input <?php echo e($ActionStatus); ?> type="text"    name="DOC_NO"  id="DOC_NO"  value="<?php echo e(isset($HDR->PKMCODE)?$HDR->PKMCODE:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>

        <div class="col-lg-1 pl"><p>Document Date*</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($HDR->PKMDATE)?$HDR->PKMDATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
        </div>

        <div class="col-lg-1 pl"><p>Business Unit*</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text"   name="BUNAME" id="BUNAME" value="<?php echo e(isset($HDR->BUNAME)?$HDR->BUNAME:''); ?>"  class="form-control"  autocomplete="off"  onclick="getBusinessUnitMaster()" readonly/>
          <input <?php echo e($ActionStatus); ?> type="hidden" name="BUID_REF" id="BUID_REF" value="<?php echo e(isset($HDR->BUID_REF)?$HDR->BUID_REF:''); ?>"      class="form-control"  autocomplete="off" />  
        </div>

        <div class="col-lg-1 pl"><p>Package Name*</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text"   name="PACKAGE_NAME" id="PACKAGE_NAME" value="<?php echo e(isset($HDR->PKMNAME)?$HDR->PKMNAME:''); ?>"  class="form-control"  autocomplete="off" />
        </div>
      </div>
      ...
      <div class="row">	
        ...
        <div class="col-lg-11 pl">
          <textarea <?php echo e($ActionStatus); ?> name="PACKAGE_DESC" id="PACKAGE_DESC" cols="118" rows="10" tabindex="3" ><?php echo e(isset($HDR->DESCRIPTIONS)?$HDR->DESCRIPTIONS:''); ?></textarea>
        </div>
      </div>  
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text"   name="HSN_DESC" id="HSN_DESC" value="<?php echo e(isset($HDR->HSN_DESC)?$HDR->HSN_DESC:''); ?>" class="form-control"  autocomplete="off"  onclick="getSacMaster()" readonly/>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl pr">
          <input <?php echo e($ActionStatus); ?> type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e(isset($HDR->DEACTIVATED) && $HDR->DEACTIVATED == 1 ? "checked" : ""); ?> value='<?php echo e(isset($HDR->DEACTIVATED) && $HDR->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="2"  >
        </div>
      ...
      <div class="row">
        ...
        <div id="Material" class="tab-pane fade in active">
                  ...
                  <?php $__currentLoopData = $DETAILS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><input <?php echo e($ActionStatus); ?>  type="text" name="popupITEMID[]" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e(isset($row->ITEM_CODE)?$row->ITEM_CODE:''); ?>" onclick="getItem(this.id)" class="form-control"  autocomplete="off"  readonly/></td>
                    <td hidden><input <?php echo e($ActionStatus); ?> type="hidden" name="ITEMID_REF[]" id="ITEMID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->ITEMID_REF)?$row->ITEMID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="ItemName[]" id="ItemName_<?php echo e($key); ?>" value="<?php echo e(isset($row->ITEM_NAME)?$row->ITEM_NAME:''); ?>" class="form-control"  autocomplete="off"  readonly  /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="popupMUOM[]" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e(isset($row->UOM_DESC)?$row->UOM_DESC:''); ?>" onclick="getUomMaster(this.id)" class="form-control"  autocomplete="off"  readonly /></td>
                    <td hidden><input <?php echo e($ActionStatus); ?> type="hidden" name="MAIN_UOMID_REF[]" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->UOMID_REF)?$row->UOMID_REF:''); ?>" class="form-control"  autocomplete="off" /></td>
                    <td><input type="text" <?php echo e($ActionStatus); ?>   name="QTY[]" id="QTY_<?php echo e($key); ?>" value="<?php echo e(isset($row->QUANTITY)?$row->QUANTITY:''); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
...
function getBusinessUnitMaster(){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[$FormId,"getBusinessUnitMaster"])); ?>',
    type:'POST',
...
function getSacMaster(){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[$FormId,"getSacMaster"])); ?>',
    type:'POST',
    success:function(data) {
      var html = '';
...
function getUomMaster(textid){
  ...
  if(ITEMID_REF ===""){
    ...
    $.ajax({
      url:'<?php echo e(route("master",[$FormId,"getUomMaster"])); ?>',
      type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/PackageMaster/mstfrm536view.blade.php ENDPATH**/ ?>