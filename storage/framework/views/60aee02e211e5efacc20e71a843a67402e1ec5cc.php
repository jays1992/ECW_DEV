                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="BALANCE_AMT[]" id="BALANCE_AMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->BALANCE_AMT)?floatval($row->BALANCE_AMT):''); ?>"     class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="NET_AMOUNT[]"  id="NET_AMOUNT_<?php echo e($key); ?>" value="<?php echo e(isset($row->NET_AMOUNT)?$row->NET_AMOUNT:''); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/masters/Sales/ValueCardAddValue/mstfrm532edit.blade.php ENDPATH**/ ?>