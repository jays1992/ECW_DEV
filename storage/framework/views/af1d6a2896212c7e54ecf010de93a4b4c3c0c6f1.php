  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Doc No*</p></div>
          ...
          <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          <?php elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1"): ?>
          <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(old('DOC_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objDD->MANUAL_MAXLENGTH)?$objDD->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
            <?php else: ?>
          <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(old('BGCODE')); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
         <?php endif; ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(old('DOC_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\ExtendedWarranty\trnfrm497add.blade.php ENDPATH**/ ?>