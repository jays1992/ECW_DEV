            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="radio" <?php echo e($ActionStatus); ?>  name="LEAD" id="WITH_LEAD" <?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" || $objSQ->QUOTATTION_TYPE =="CUSTOMER" ? "checked":""); ?> value="WITH_LEAD" class="form-radio" >
                            </div>                            
                            
                            <div class="col-lg-2 pl"><p>Without Lead</p></div>
                            <div class="col-lg-2 pl">
                            <input type="radio" name="LEAD" <?php echo e($ActionStatus); ?> <?php echo e($objSQ->QUOTATTION_TYPE =="DIRECT" ? "checked":""); ?> id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="date"  <?php echo e($ActionStatus); ?> name="SQDT" id="SQDT" onchange="checkPeriodClosing(36,this.value,1)"  value="<?php echo e(isset($objSQ->SQDT)?$objSQ->SQDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>


                            <div class="col-lg-2 pl"><p id="customer_prospect"> <?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" ? "Prospect *":"Customer *"); ?></p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="SubGl_popup" id="txtgl_popup" value="<?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" ?   $objSQ->PCODE. '-'.$objSQ->NAME: $objsubglcode->SGLCODE .'-'.$objsubglcode->SLNAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="divcurrency" >
                                ...
                                <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e($objSQcurrency); ?>"   />
                                <?php else: ?>
                                <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
                                <?php endif; ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSQ->CONVFACT)?$objSQ->CONVFACT:''); ?>" <?php echo e(isset($objSQ->FC) && $objSQ->FC == 1 ? 'readonly' : 'disabled'); ?> />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input type="text" <?php echo e($ActionStatus); ?> name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e(isset($objBillAddress[0])?$objBillAddress[0]:''); ?>" readonly  />
                                            ...
                                            <?php if(!empty($objSQMAT)): ?>
                                                <?php $__currentLoopData = $objSQMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SQ_QTY_".$key); ?> id=<?php echo e("SQ_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->SQ_QTY); ?>"  autocomplete="off"  /></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits blurRate" maxlength="13" value="<?php echo e($row->RATEPUOM); ?>"  autocomplete="off" /></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly/></td>
                                                        <?php
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly/></td>
                                                        <?php
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->SGST); ?>" autocomplete="off"  readonly/></td>
                                                        <?php
                                                        ...
                                                        <td align="center"><button class="btn add material" <?php echo e($ActionStatus); ?> title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button class="btn remove dmaterial" <?php echo e($ActionStatus); ?> title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesQuotation\trnfrm36edit.blade.php ENDPATH**/ ?>