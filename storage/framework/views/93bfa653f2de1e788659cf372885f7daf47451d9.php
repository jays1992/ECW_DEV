                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="CARD_NO[]" id="CARD_NO_<?php echo e($key); ?>" value="<?php echo e(isset($row->CARD_NO)?$row->CARD_NO:''); ?>"      class="form-control"  autocomplete="off" maxlength="15" /></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="AMOUNT[]" id="AMOUNT_<?php echo e($key); ?>" value="<?php echo e(isset($row->AMOUNT)?$row->AMOUNT:''); ?>"        class="form-control"  autocomplete="off" onclick="getAmountMaster(this.id)"  readonly/></td>
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="DISCOUNT_PERCENT[]" id="DISCOUNT_PERCENT_<?php echo e($key); ?>" value="<?php echo e(isset($row->DISCOUNT_PERCENT)?$row->DISCOUNT_PERCENT:''); ?>"      class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="DISCOUNT_AMT[]" id="DISCOUNT_AMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->DISCOUNT_AMT)?$row->DISCOUNT_AMT:''); ?>"      class="form-control"  autocomplete="off"  readonly/></td>
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="VALIDITY_MON[]" id="VALIDITY_MON_<?php echo e($key); ?>" value="<?php echo e(isset($row->VALIDITY_MON)?$row->VALIDITY_MON:''); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\ValueCardMaster\mstfrm531view.blade.php ENDPATH**/ ?>