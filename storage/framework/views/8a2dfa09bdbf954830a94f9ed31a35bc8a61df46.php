...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
            ...
            <?php if($objDD->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="BASIS_DOC_NO" id="BASIS_DOC_NO" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <?php endif; ?>
            <?php if($objDD->MANUAL_SR == "1"): ?>
                <input type="text" name="BASIS_DOC_NO" id="BASIS_DOC_NO" value="<?php echo e(old('BASIS_DOC_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objDD->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Payroll\Calculation_Basis\mstfrm199add.blade.php ENDPATH**/ ?>