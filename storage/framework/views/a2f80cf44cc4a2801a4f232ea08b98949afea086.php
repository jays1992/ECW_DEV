    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <a href='<?php echo e(route("master",[147,"index"])); ?>' class="btn topnavbt"><i class="fa fa-power-off"></i> Exit</a>
                </div><!--col-10-->
         ...
         <form id="frm_mst_edit" method="POST"  enctype="multipart/form-data" > 
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="ANO" id="ANO" value="<?php echo e(isset($objResponse->AMENDENT_NUMBER) && $objResponse->AMENDENT_NUMBER !=''?$objResponse->AMENDENT_NUMBER+1:1); ?>"  class="form-control" autocomplete="off" readonly />
            </div>

            <div class="col-lg-1 pl"><p>Amendment Date</p></div>
            <div class="col-lg-2 pl">
              <input type="date" name="AMENDMENT_DATE" id="AMENDMENT_DATE" value="<?php echo e(isset($objResponse->AMENDENT_DATE) && $objResponse->AMENDENT_DATE !=''?$objResponse->AMENDENT_DATE:''); ?>"  class="form-control mandatory" autocomplete="off">
            </div>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[147,"saveamendment"])); ?>',
            type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Common\BranchMaster\mstfrm147amendment.blade.php ENDPATH**/ ?>