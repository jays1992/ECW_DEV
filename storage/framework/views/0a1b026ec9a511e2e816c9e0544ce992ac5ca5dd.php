            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" <?php echo e($ActionStatus); ?> name="SODT" id="SODT" value="<?php echo e(isset($objSO->SODT)?$objSO->SODT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="divcurrency" >
                                ...
                                <?php if($objsocurrency): ?>
                                <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objsocurrency[0])?$objsocurrency[0]:''); ?>"   />
                                <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSO->CONVFACT)?$objSO->CONVFACT:''); ?>" <?php echo e(isset($objSO->SOFC) && $objSO->SOFC  == 1 ? 'readonly' : 'disabled'); ?> />
                            </div>
                        </div>
                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                ...
                                                ?>
                                                    ...
                                                    <td><input type="text" name=<?php echo e("LEADDT_".$key); ?> id=<?php echo e("LEADDT_".$key); ?>  class="form-control"  autocomplete="off"  readonly value="<?php echo e($row->LEAD_DT); ?>"  style="width:130px;"/></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SO_QTY_".$key); ?> id=<?php echo e("SO_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($SO_QTY); ?>"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCal(this.id)" onfocusout="dataDec(this,'2')" /></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits blurRate" maxlength="13" value="<?php echo e($RATEPUOM); ?>"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCal(this.id)" onfocusout="dataDec(this,'5')" /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesOrder\trnfrm38view.blade.php ENDPATH**/ ?>