                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="PRODUCT_CODE[]" id="PRODUCT_CODE_<?php echo e($key); ?>"         value="<?php echo e(isset($row->ICODE)?$row->ICODE:''); ?>"   class="form-control"  autocomplete="off" onclick="getProduct(this.id)"  readonly/></td>
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="PRODUCT_NAME[]" id="PRODUCT_NAME_<?php echo e($key); ?>"         value="<?php echo e(isset($row->NAME)?$row->NAME:''); ?>"   class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="SALES_PRICE[]" id="SALES_PRICE_<?php echo e($key); ?>"           value="<?php echo e(isset($row->SALE_PRICE)?$row->SALE_PRICE:''); ?>"         onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="PURCHASE_PRICE[]"  id="PURCHASE_PRICE_<?php echo e($key); ?>"    value="<?php echo e(isset($row->PURCHASE_PRICE)?$row->PURCHASE_PRICE:''); ?>"    onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td align="center">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\ProductPriceListMaster\mstfrm535view.blade.php ENDPATH**/ ?>