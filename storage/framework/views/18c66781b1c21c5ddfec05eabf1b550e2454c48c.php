...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              <?php if(isset($objPBDOCNO->SYSTEM_GRSR) && $objPBDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="PB_DOCNO" id="PB_DOCNO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
           
              <?php elseif(isset($objPBDOCNO->MANUAL_SR) && $objPBDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="PB_DOCNO" id="PB_DOCNO" value="<?php echo e(old('PB_DOCNO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objPBDOCNO->MANUAL_MAXLENGTH)?$objPBDOCNO->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
             
              <?php else: ?>
                <input type="text" name="PB_DOCNO" id="PB_DOCNO" value="<?php echo e(old('PB_DOCNO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
              <?php endif; ?>
        </div>
        <div class="col-lg-1 pl"><p>PB Doc Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PB_DOCDT" id="PB_DOCDT" value="<?php echo e(old('PB_DOCDT')); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\PurchaseInvoice\trnfrm236add.blade.php ENDPATH**/ ?>