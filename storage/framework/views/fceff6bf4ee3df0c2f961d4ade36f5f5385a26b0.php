            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <?php if(isset($objSCN->SYSTEM_GRSR) && $objSCN->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="SCNO" id="SCNO" value="<?php echo e(isset($objSCNO)?$objSCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            <?php elseif(isset($objSCN->MANUAL_SR) && $objSCN->MANUAL_SR == "1"): ?>
                                <input type="text" name="SCNO" id="SCNO"  class="form-control mandatory" maxlength="<?php echo e(isset($objSCN->MANUAL_MAXLENGTH)?$objSCN->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
                            <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesChallan\trnfrm43add.blade.php ENDPATH**/ ?>