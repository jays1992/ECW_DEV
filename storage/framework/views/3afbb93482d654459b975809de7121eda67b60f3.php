            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                               
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($objSO->DEALER_COMMISSION_AMT) && $objSO->DEALER_COMMISSION_AMT !='' && $objSO->DEALERID_REF !=''?number_format($objSO->DEALER_COMMISSION_AMT, 2, '.', ''):''); ?>"  name="DEALER_COMMISSION_AMT" id="DEALER_COMMISSION_AMT" readonly autocomplete="off" class="form-control" maxlength="100"  />
                            </div>
                        ...
                        <div class="row"> 
                          ...
                          <div class="col-lg-2 pl">
                            <select <?php echo e($ActionStatus); ?> name="PRICE_BASED_ON" id="PRICE_BASED_ON" class="form-control mandatory" onchange="resetTab()" >
                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                ...
                                                ?>
                                                    ...
                                                    <td><input type="text" name=<?php echo e("LEADDT_".$key); ?> id=<?php echo e("LEADDT_".$key); ?>  class="form-control"  autocomplete="off"  readonly value="<?php echo e($row->LEAD_DT); ?>"  style="width:130px;"/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("DISAFTT_AMT_".$key); ?> id=<?php echo e("DISAFTT_AMT_".$key); ?> value="<?php echo e($TaxAmt); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> value="<?php echo e($IGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> value="<?php echo e($CGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> value="<?php echo e($SGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <?php
                                                            $IGSTAMT=number_format((((($SO_QTY*$RATEPUOM) - $DISCOUNT_AMT)*$IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($SO_QTY*$RATEPUOM) - $DISCOUNT_AMT)*$CGST)/100),2, '.', '');
                                                            $SGSTAMT=number_format((((($SO_QTY*$RATEPUOM) - $DISCOUNT_AMT)*$SGST)/100),2, '.', '');
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("TGST_AMT_".$key); ?> id=<?php echo e("TGST_AMT_".$key); ?> value="<?php echo e($TOTGST); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <?php
                                                            $TaxAmt=number_format((($SO_QTY*$RATEPUOM) - $DISCOUNT_AMT),2, '.', '');
                                                            $IGSTAMT=number_format((((($SO_QTY*$RATEPUOM) - $DISCOUNT_AMT)*$IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($SO_QTY*$RATEPUOM) - $DISCOUNT_AMT)*$CGST)/100),2, '.', '');
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> value="<?php echo e($TOTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
      ...
      if($(this).is(":checked") == true) 
      {
        ...
        if($.trim($("#SCHEMEID_REF").val()) ==='' && jQuery.inArray(txtenqitem, SalesEnq2) !== -1 && parseFloat(offer_status) == 0){
              ...
              return false;
                ...
                $('#'+txt_id14).val(txtauomqty);
                $('#'+txt_id15).val(txtruom);
                get_delear_customer_price(txt_id15,'change');
                $('#'+txt_id16).val(txtmuomqty);
                $('#'+txtid).parent().parent().find('[id*="SEQID_REF"]').val(txtenqid);
                $('#'+txtid).parent().parent().find('[id*="DISAFTT_AMT"]').val(txtamt);
                $('#'+txtid).parent().parent().find('[id*="TOT_AMT"]').val(txttotamtatax);
...
if(altuomid !='' && id === "ALT_UOMID_QTY_"+index){
            ...
            $.ajax({
              url:'<?php echo e(route("transaction",[$FormId,"getmainuomqty"])); ?>',
              type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/transactions/sales/SalesOrder/trnfrm38edit.blade.php ENDPATH**/ ?>