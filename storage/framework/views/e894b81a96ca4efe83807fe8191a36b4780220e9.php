          ...
          <div id="Material" class="tab-pane fade in active">
              ...
              <thead id="thead1"  style="position: sticky;top: 0">
                  ...
                  <tr>
                    ...
                    <td><input type="text" style="width:130px;text-align:right;"   name="QTY[]" id="QTY_0" class="form-control three-digits"     onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" maxlength="13"  autocomplete="off"   /></td>

                    <td><input type="text"  name="RATEPUOM[]" id="RATEPUOM_0" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'5')" /></td>

                    <td><input  type="text" name="DISCPER[]" id="DISCPER_0" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>

                    <td><input  type="text" name="DISCOUNT_AMT[]" id="DISCOUNT_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>
                ...
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody>
                          <tr  class="participantRow2">
                              ...
                              <td><input type="text" name="PAID_AMT[]" id="PAID_AMT_0" onkeyup="bindTotalValue()"  onfocusout="dataDec(this,'2')" class="form-control two-digits"  autocomplete="off"  /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\sales\AccessoryInvoice\trnfrm541add.blade.php ENDPATH**/ ?>