...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Accessory Invoice</a>
    </div>
  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->ACCID); ?>" value="<?php echo e($val->ACCID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->DOC_NO) && $val->DOC_NO !=''?$val->DOC_NO:''); ?></td>
          <td><?php echo e(isset($val->DOC_DATE) && $val->DOC_DATE !=''?$val->DOC_DATE:''); ?></td>
          <td><?php echo e(isset($val->CUSTOMER_TYPE) && $val->CUSTOMER_TYPE !=''?$val->CUSTOMER_TYPE:''); ?></td>
    ...
    <form id="transactionForm268Print" action="<?php echo e(route('transactiongetlist',[$FormId,'printdata'])); ?>" method="POST" >
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\EECW\resources\views/transactions/Sales/AccessoryInvoice/trnfrm541.blade.php ENDPATH**/ ?>