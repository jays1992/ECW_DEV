...
<form id="transaction_data_form" method="POST"  >
  <div class="container-fluid purchase-order-view"> 
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="KNOCKOFF_DT" id="KNOCKOFF_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($HDR->KNOCKOFF_DT) && $HDR->KNOCKOFF_DT !=''?$HDR->KNOCKOFF_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
...
function validateForm(ActionType,ActionMsg){
  ...
  else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#KNOCKOFF_DT").val(),0) ==0){
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn").hide();
    $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\inventory\KnowkOff\trnfrm313edit.blade.php ENDPATH**/ ?>