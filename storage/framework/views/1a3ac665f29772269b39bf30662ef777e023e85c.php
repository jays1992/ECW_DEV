      ...
      <div class="inner-form"> 
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="DISCODE" id="DISCODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="date" name="VALID_FROM" id="VALID_FROM" class="form-control" autocomplete="off" value="<?php echo e(date('Y-m-d')); ?>" >
          </div>

          <div class="col-lg-2 pl"><p>Valid To*</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="VALID_TO" id="VALID_TO" class="form-control" autocomplete="off" value="<?php echo e(date('Y-m-d')); ?>" >
          </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\DiscountMaster\mstfrm527add.blade.php ENDPATH**/ ?>