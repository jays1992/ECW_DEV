...
<?php $__env->startSection('content'); ?>    
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Sale</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->VCS_ID); ?>" value="<?php echo e($val->VCS_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->docdate) && $val->docdate !='' && $val->docdate !='1900-01-01' ? date('d-m-Y',strtotime($val->docdate)):''); ?>" ></td>
              <td><?php echo e(isset($val->DOC_NO) && $val->DOC_NO !=''?$val->DOC_NO:''); ?></td>
              <td><?php echo e(isset($val->DOC_DATE) && $val->DOC_DATE !='' && $val->DOC_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DOC_DATE)):''); ?></td>
              <td><?php echo e(isset($val->NAME) && $val->NAME !=''?$val->NAME:''); ?></td>
              <td><?php echo e(isset($val->MOBILE_NO) && $val->MOBILE_NO !=''?$val->MOBILE_NO:''); ?></td>
              <td><?php echo e(isset($val->EMAIL_ID) && $val->EMAIL_ID !=''?$val->EMAIL_ID:''); ?></td>
              <td><?php echo e(isset($val->CARDNO) && $val->CARDNO !=''?$val->CARDNO:''); ?></td>
              <td><?php echo e(isset($val->CURRENT_BALANCE) && $val->CURRENT_BALANCE !=''?$val->CURRENT_BALANCE:''); ?></td>
              <!--<td></td>-->
              <td><?php echo e(isset($val->VALIDITY_TO) && $val->VALIDITY_TO !=''?$val->VALIDITY_TO:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/transactions/sales/ValueCardSales/trnfrm543.blade.php ENDPATH**/ ?>