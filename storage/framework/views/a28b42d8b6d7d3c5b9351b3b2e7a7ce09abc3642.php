...
<link href="<?php echo e(asset('css/innerdesign.css')); ?>" rel="stylesheet" type="text/css">
	...
	<aside class="app-sidebar" role="navigation">
		<div class="main-sidebar-header">
			<div class="desktop-logo">
				<a href="#" id="btnExit"><img src="<?php echo e(asset('img/white-logo1.png')); ?>" class="main-logo" style="width: 130px; height: 50px;" /></a>
			</div>
		</div>
...
</html><?php /**PATH C:\xampp\htdocs\PROJECTS\ECW_DEV\resources\views/layouts/app.blade.php ENDPATH**/ ?>