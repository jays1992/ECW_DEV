...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Banner Image</a>
      </div>
...
<div class="container-fluid purchase-order-view filter">     
  ...
  <?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->BRIMG_ID) ? method_field('PUT') : ''); ?>
  ...
  <div class="inner-form">
      ...
      <div class="row">    
        ...
        <div class="col-lg-2 pl">
        <input type="file" name="UPLOADBANNER" id="UPLOADBANNER" value="<?php echo e(isset($objResponse->UPLOADBANNER) && $objResponse->UPLOADBANNER !=''?$objResponse->UPLOADBANNER:''); ?>" class="form-control"/>
          <span class="text-danger" id="ERROR_UPLOADBANNER"></span>
        </div>

        <div class="col-lg-1 pl"><p>Heading</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="HEADING" id="HEADING" value="<?php echo e(isset($objResponse->HEADING) && $objResponse->HEADING !=''?$objResponse->HEADING:''); ?>" class="form-control"/>
          <span class="text-danger" id="ERROR_HEADING"></span> 
        </div>

        <div class="col-lg-1 pl"><p>Description</p></div>
        <div class="col-lg-2 pl">
        <input type="text" name="DESCRIPTIONS" id="DESCRIPTION" value="<?php echo e(isset($objResponse->DESCRIPTIONS) && $objResponse->DESCRIPTIONS !=''?$objResponse->DESCRIPTIONS:''); ?>" class="form-control" />
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                  <td><input disabled type="checkbox" name="FRANCHISEE_REF[<?php echo e($key); ?>]" <?php echo e($row->BRID ==$row->FRANCHISEE_REF?'checked':''); ?> value="<?php echo e($row->BRID); ?>" class="checkbox" ></td>
                  <td><input disabled type="text" name="FRANCHISEE_CODE_<?php echo e($key); ?>" id="FRANCHISEE_CODE_<?php echo e($key); ?>" value="<?php echo e($row->BRCODE); ?>" class="form-control showEmp" readonly  style="width:100%;"  /></td>
                  <td><input  disabled type="text" id ="FRANCHISEE_NAME_<?php echo e($key); ?>"  id ="FRANCHISEE_NAME_<?php echo e($key); ?>" value="<?php echo e($row->BRNAME); ?>" class="form-control w-100" maxlength="200" readonly style="width:100%;" ></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Sales/BannerImage/mstfrm560view.blade.php ENDPATH**/ ?>