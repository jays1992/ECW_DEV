                  ...
                  <div class="col-lg-2 pl"><p>Doc No*</p></div>
                    <div class="col-lg-2 pl">
                      ...
                      <?php if($objDD->SYSTEM_GRSR == "1"): ?>
                          <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                      <?php endif; ?>
                      <?php if($objDD->MANUAL_SR == "1"): ?>
                          <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="<?php echo e(old('PROVISION_DOC_NO')); ?>" class="form-control mandatory"  maxlength="<?php echo e($objDD->MANUAL_MAXLENGTH); ?>" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
                      <?php endif; ?>
                  <?php endif; ?> 
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="PROVISION_DT" id="PROVISION_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Payroll\ProvisionOfBonusGratuityLeaveEncashment\trnfrm416add.blade.php ENDPATH**/ ?>