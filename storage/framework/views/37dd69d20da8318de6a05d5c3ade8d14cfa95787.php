            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="SSO_DT" id="SSO_DT" value="<?php echo e(isset($objSO->SSO_DT)?$objSO->SSO_DT:''); ?>" class="form-control mandatory" autocomplete="off" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 pl">
                                <input <?php echo e($InputStatus); ?> type="checkbox" name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objSO->FC) && $objSO->FC == 1 ? 'checked' : ''); ?> >
                            </div>
                            
                            <div class="col-lg-1 pl col-md-offset-1"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                <?php if(count($objsocurrency) > 0): ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objsocurrency[0])?$objsocurrency[0]:''); ?>"   />
                                <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="CONV_FACT" id="CONV_FACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSO->CONV_FACT)?$objSO->CONV_FACT:''); ?>" readonly />
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\sales\SalesServiceOrder\trnfrm151view.blade.php ENDPATH**/ ?>