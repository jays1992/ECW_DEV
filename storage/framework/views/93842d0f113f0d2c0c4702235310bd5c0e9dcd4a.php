    ...
    <div class="inner-form">
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="PCODE" id="PCODE" value="<?php echo e(isset($objDOCNO)?$objDOCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          <?php elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1"): ?>
          <input type="text" name="PCODE" id="PCODE" class="form-control mandatory" maxlength="<?php echo e(isset($objDD->MANUAL_MAXLENGTH)?$objDD->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\PreSales\ProspectMaster\mstfrm441add.blade.php ENDPATH**/ ?>