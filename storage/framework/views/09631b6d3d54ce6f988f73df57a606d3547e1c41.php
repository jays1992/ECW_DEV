...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[$FormId,'index'])); ?>" class="btn singlebt">Value Card Sale History</a>
                </div><!--col-2-->
                            ...
                            <div class="col-lg-3 pl">
                                <select name="CardNo[]" data-hide-disabled="hide" multiple data-actions-box="true" id="CardNo"  class="form-control selectpicker" multiple data-live-search="true"  >
                                    <?php $__currentLoopData = $objCard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bindex=>$bRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bRow->DATA_ID); ?>" selected><?php echo e($bRow->DATA_CODE); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/reports/purchase/ValueCardSaleHistory/rptfrm553.blade.php ENDPATH**/ ?>