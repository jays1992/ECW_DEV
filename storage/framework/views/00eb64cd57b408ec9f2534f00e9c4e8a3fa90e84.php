	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              <?php if(isset($objJV->SYSTEM_GRSR) && $objJV->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="JV_NO" id="JV_NO" value="<?php echo e(isset($objJVNO)?$objJVNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              
              <?php elseif(isset($objJV->MANUAL_SR) && $objJV->MANUAL_SR == "1"): ?>
                  <input type="text" name="JV_NO" id="JV_NO" value="<?php echo e(old('JV_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objJV->MANUAL_MAXLENGTH)?$objJV->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
              <?php else: ?>
        ...
        <div class="col-lg-2 pl">
                  <input type="date" name="JV_DT" id="JV_DT" value="<?php echo e(old('JV_DT')); ?>" onchange="checkPeriodClosing(169,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\JournalVoucher\trnfrm169add.blade.php ENDPATH**/ ?>