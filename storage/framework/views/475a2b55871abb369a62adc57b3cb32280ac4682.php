  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="PRO_NO" id="PRO_NO" value="<?php echo e($objDataNo); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          <?php endif; ?>

          <?php if(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
          <input type="text" name="PRO_NO" id="PRO_NO" value="<?php echo e(old('PRO_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php endif; ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PRO_DT" id="PRO_DT" value="<?php echo e(old('PRO_DT')); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Production\ProductionOrder\trnfrm239add.blade.php ENDPATH**/ ?>