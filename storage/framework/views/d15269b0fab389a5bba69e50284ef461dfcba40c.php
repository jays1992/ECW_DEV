    ...
    <div class="container-fluid filter">
      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            <?php if($objBDS->SYSTEM_GRSR == "1"): ?>
                <input type="text" name="BDSL_NO" id="BDSL_NO" value="<?php echo e($objBDSO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            <?php endif; ?>
            <?php if($objBDS->MANUAL_SR == "1"): ?>
                <input type="text" name="BDSL_NO" id="BDSL_NO" value="<?php echo e(old('BDSL_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objBDS->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="BDSL_DATE" id="BDSL_DATE" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(old('BDSL_DATE')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\PlantMaintenance\Break_down_Solution\trnfrm365add.blade.php ENDPATH**/ ?>