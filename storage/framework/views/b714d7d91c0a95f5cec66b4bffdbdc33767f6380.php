...
<div class="container-fluid filter">
  <form id="frm_trn_pay"  method="POST"> 
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="date" name="PAYMENT_DT" id="PAYMENT_DT" value="<?php echo e(isset($objPAYHDR->PAYMENT_DT)?$objPAYHDR->PAYMENT_DT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        ...
        <?php $__currentLoopData = $objBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$bkRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <td style="text-align:center; width:6%"> <input type="checkbox"    id="bkidcode_<?php echo e($index); ?>" class="clsbkid" value="<?php echo e($bkRow->BID); ?>" name="bankcash[]" ></td>
              <td style="width:10%;"><?php echo e($bkRow-> BCODE); ?>
                ...
                <input type="hidden" id="txtbkidcode_<?php echo e($index); ?>" data-desc="<?php echo e($bkRow-> BCODE); ?>" data-desc2="<?php echo e($bkRow-> NAME); ?>"  data-desc3="<?php echo e($bkRow-> BANK_CASH); ?>" data-glid_ref="<?php echo e($bkRow->GLID_REF); ?>" data-odlimit="<?php echo e($bkRow->ODLIMIT !=''? $bkRow->ODLIMIT:'0.00'); ?>" value="<?php echo e($bkRow-> BID); ?>"/>
              </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\09082022\Accounts\PaymentEntry\trnfrm301edit.blade.php ENDPATH**/ ?>