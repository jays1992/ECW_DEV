...
<div class="col-lg-2 pl"><p> Compnay Owned Franchise</p></div>
        ...
        <input type="checkbox" disabled name="OWNED_FRANCHISE" id="OWNED_FRANCHISE" <?php echo e(isset($objResponse->OWNED) && $objResponse->OWNED==1? 'checked':''); ?> class="form-checkbox" tabindex="33" >
...
<div class="row">
  ...
  <div class="col-lg-2 pl">
    <label><?php echo e(isset($HDR->PLCODE)?$HDR->PLCODE:''); ?><?php echo e(isset($HDR->PLNAME) && $HDR->PLNAME !=''?'-'.$HDR->PLNAME:''); ?></label>
  </div>

  <div class="col-lg-1 pl"><p>Franchisee label</p></div>
  <div class="col-lg-2 pl">
    <label><?php echo e(isset($HDR->FRANCHISEE_LABEL)?$HDR->FRANCHISEE_LABEL:''); ?></label>
  </div>
</div>
...
<div id="ALPSSpecific" class="tab-pane fade">                    
		...
		<div class="table-wrapper-scroll-x" style="margin-top:10px;">
			<div class="row">
				...
				<div class="col-lg-3 ">
				  <input type="file" disabled name="LOGO" id="LOGO" accept="image/*"  class="form-control" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ECW\resources\views/masters/Common/BranchMaster/mstfrm147view.blade.php ENDPATH**/ ?>