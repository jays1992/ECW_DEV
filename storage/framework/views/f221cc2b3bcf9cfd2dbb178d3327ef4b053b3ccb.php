                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input  <?php echo e($InputStatus); ?> type="text" name="CREDITDAYS" id="CREDITDAYS" value="<?php echo e(isset($objSO->CREDIT_DAYS)?$objSO->CREDIT_DAYS:''); ?>" class="form-control" autocomplete="off"/>
                            </div>
                        </div>
                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                <?php $__currentLoopData = $objSOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        ...
                                                        <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="18" value="<?php echo e($row->RATE_PRUOM); ?>"  autocomplete="off" style="width:130px;text-align:right;" /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\sales\SalesServiceInvoice\trnfrm156edit.blade.php ENDPATH**/ ?>