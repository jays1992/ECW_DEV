                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                        <div class="col-lg-12 pl">
                          <input type="text" name="TNC_CODE" id="txttnccode" class="form-control mandatory" value="<?php echo e($objCondition->TNC_CODE); ?>"  maxlength="50"   autocomplete="off" tabindex="1" style="text-transform:uppercase" readonly >
                        </div>
                      </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Accounts\Terms&ConditionTemplate\mstfrm94edit.blade.php ENDPATH**/ ?>