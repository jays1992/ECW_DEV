         ...
         <form id="frm_mst_edit" method="POST"  > 
          ...
          <div class="inner-form">
            ...
            <div class="row" >
              ...
              <div class="col-lg-2 pl">
                <input type="text"   name="BRANCH_NAME" id="BRANCH_NAME" value="<?php echo e(isset($HDR[0]->BRANCH_NAME)?$HDR[0]->BRANCH_NAME:''); ?>"  class="form-control"  autocomplete="off"  onclick="getBranchMaster()" readonly required/>
                <input type="hidden" name="BRANCH_ID" id="BRANCH_ID" value="<?php echo e(isset($HDR[0]->BRANCH_ID)?$HDR[0]->BRANCH_ID:''); ?>"     class="form-control"  autocomplete="off" />  
              </div>
...
function getBranchMaster(){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[145,"getBranchMaster"])); ?>',
    type:'POST',
    success:function(data) {
      var html = '';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Common/DocumentNumberDefinition/mstfrm145edit.blade.php ENDPATH**/ ?>