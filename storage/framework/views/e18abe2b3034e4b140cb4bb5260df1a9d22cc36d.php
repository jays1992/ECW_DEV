    ...
    <div class="row" id="divcust1"  style="display:none">
        ...
        <div class="col-lg-2 pl">
            <?php if(isset($objPAYHDR->CUSTMER_VENDOR_ID) && $objPAYHDR->CUSTMER_VENDOR_ID != ''): ?>
               <input <?php echo e($ActionStatus); ?> type="text" name="txtcustomer" id="txtcustomer" class="form-control" value="<?php echo e(isset($objPAYCUSTVNDR->CODE)?$objPAYCUSTVNDR->CODE:''); ?> <?php echo e(isset($objPAYCUSTVNDR->NAME)?$objPAYCUSTVNDR->NAME:''); ?>" readonly  />
            <?php else: ?>
                    ...
                    <?php if(!empty($objPAYINV)): ?>
                      <?php $__currentLoopData = $objPAYINV; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow2">
                              ...
                              <td hidden><input type="hidden" name=<?php echo e("DOCNO_ID_".$key); ?> id=<?php echo e("DOCNO_ID_".$key); ?> class="form-control" value="<?php echo e($row->DOCNO_ID); ?>" autocomplete="off" /> <input type="hidden" name="rowcount1[]" id="rowcount1[]" class="form-control" autocomplete="off" /></td>
                  ...
                  <?php if(!empty($objPAYACCOUNT)): ?>
                    <?php $__currentLoopData = $objPAYACCOUNT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gkey => $grow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      ?>
                          ...
                          <td>
                          <select name=<?php echo e("TYPE_".$gkey); ?> id=<?php echo e("TYPE_".$gkey); ?>   class="form-control" style="width: 85px;">
                      ...
                      ?>
                          ...
                          <td align="center" ><button <?php echo e($ActionStatus); ?> class="btn add aaccount" title="add" data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button><button <?php echo e($ActionStatus); ?> class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                      </tr>
                      <tr></tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php else: ?>
...
$('#btnPrint').on('click', function() {
            var DOCID    ='<?php echo e($objPAYHDR->PAYMENTID); ?>';     
            var Flag    = 'H';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\transactions\Accounts\PaymentEntry\trnfrm301view.blade.php ENDPATH**/ ?>