<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[147,'index'])); ?>" class="btn singlebt">Franchise Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
          ...
          <div class="inner-form">
              ...
              <div class="col-lg-2 pl">
                ...
                <span class="text-danger" id="ERROR_CYID_REF"></span> 
                  ...
                  <div class="col-lg-1 pl"><p>Franchise Code</p></div>
                  <div class="col-lg-2 pl">
                ...
                <div class="col-lg-1 pl"><p>Franchise Group</p></div>
              <div class="col-lg-2 pl">
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl"><p>Franchise Address Line 1</p></div>
                <div class="col-lg-2 pl">
                ...
                <div class="col-lg-1 pl "><p>Franchise Address Line 2</p></div>
                <div class="col-lg-2 pl">
        ...
        <span class="text-danger" id="ERROR_EMAILID"></span>
			...
			<div class="col-lg-1 pl"><p>Additional Phone No</p></div>
			<div class="col-lg-2 pl">
    ...
    <div class="col-lg-1 pl"><p>Designation</p></div>
      ...
      <div class="col-lg-2 pl"><p> Compnay Owned Franchise</p></div>
			<div class="col-lg-1 pl">
        <input type="checkbox" name="OWNED_FRANCHISE" id="OWNED_FRANCHISE" <?php echo e(isset($objResponse->OWNED) && $objResponse->OWNED==1? 'checked':''); ?> class="form-checkbox" tabindex="33" >
  ...
  <div class="row">
  <div class="col-lg-1 pl"><p>Price Level*</p></div>
    <div class="col-lg-2 pl">
      <input type="text"   name="PRICE_LEVEL" id="PRICE_LEVEL" onclick="getPriceLevel()" value="<?php echo e(isset($HDR->PLCODE)?$HDR->PLCODE:''); ?><?php echo e(isset($HDR->PLNAME) && $HDR->PLNAME !=''?'-'.$HDR->PLNAME:''); ?>"  class="form-control"  autocomplete="off"  readonly/>
    ...
    <div class="col-lg-1 pl"><p>Franchisee label*</p></div>
      <div class="col-lg-2 pl">
        <select name="FRANCHISEE_LABEL" id="FRANCHISEE_LABEL" class="form-control mandatory" tabindex="30" >
          <option <?php echo e(isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Other'?'selected="selected"':''); ?> value="Other">Other</option>
          <option <?php echo e(isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Platinum'?'selected="selected"':''); ?> value="Platinum">Platinum</option>
          <option <?php echo e(isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Gold'?'selected="selected"':''); ?> value="Gold">Gold</option>
          <option <?php echo e(isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Silver'?'selected="selected"':''); ?> value="Silver">Silver</option>
				</select>
        <span class="text-danger" id="ERROR_FRANCHISEE_LABEL"></span>
      </div>
...
<div id="ALPSSpecific" class="tab-pane fade">                    
		...
		<div class="table-wrapper-scroll-x" style="margin-top:10px;">
			<div class="row">
				<div class="col-lg-2 "><p>Franchise Logo </p></div>
				<div class="col-lg-3 ">
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    $("#PRICE_LEVEL").blur(function(){
        $(this).val($.trim( $(this).val() ));
        $("#ERROR_PRICE_LEVEL").hide();
        validateSingleElemnet("PRICE_LEVEL");
    });

    $( "#PRICE_LEVEL" ).rules( "add", {
        required: true,
        normalizer: function(value) {
            return $.trim(value);
        },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\ECW\resources\views/masters/Common/BranchMaster/mstfrm147edit.blade.php ENDPATH**/ ?>