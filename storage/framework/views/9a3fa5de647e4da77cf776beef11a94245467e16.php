...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Product Price List Master</a></div>
      ...
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            ...
            <input <?php echo e($ActionStatus); ?> type="text"    name="DOC_NO"     id="DOC_NO"  value="<?php echo e(isset($HDR->PPLM_NO)?$HDR->PPLM_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>

          <div class="col-lg-2 pl"><p>Document Date*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($HDR->PPLM_DATE)?$HDR->PPLM_DATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
          </div>

          <div class="col-lg-2 pl"><p>Price Level*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text"   name="PRICE_LEVEL" id="PRICE_LEVEL" onclick="getPriceLevel()" value="<?php echo e(isset($HDR->PLCODE)?$HDR->PLCODE:''); ?>"  class="form-control"  autocomplete="off"  readonly/>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td><input  class="form-control" type="text" name="SRNo[]" id ="SRNo_<?php echo e($srno); ?>"         value="<?php echo e($srno); ?>" autocomplete="off" readonly></td>
                      <td><input type="text" name="PRODUCT_CODE[]" id="PRODUCT_CODE_<?php echo e($key); ?>"         value="<?php echo e(isset($row->ICODE)?$row->ICODE:''); ?>"   class="form-control"  autocomplete="off" onclick="getProduct(this.id)"  readonly/></td>
                      <td hidden><input type="text" name="ITEM_REF[]" id="ITEM_REF_<?php echo e($key); ?>"          value="<?php echo e(isset($row->ITEMID)?$row->ITEMID:''); ?>"   class="form-control"  autocomplete="off" /></td>
                      <td><input type="text" name="PRODUCT_NAME[]" id="PRODUCT_NAME_<?php echo e($key); ?>"         value="<?php echo e(isset($row->NAME)?$row->NAME:''); ?>"   class="form-control"  autocomplete="off"  readonly/></td>
                      <td><input type="text" name="SALES_PRICE[]" id="SALES_PRICE_<?php echo e($key); ?>"           value="<?php echo e(isset($row->SALE_PRICE)?$row->SALE_PRICE:''); ?>"         onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td><input type="text" name="PURCHASE_PRICE[]"  id="PURCHASE_PRICE_<?php echo e($key); ?>"    value="<?php echo e(isset($row->PURCHASE_PRICE)?$row->PURCHASE_PRICE:''); ?>"    onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td align="center">
                      <button class="btn add" title="add" data-toggle="tooltip" id ="SRLNo_<?php echo e($sr_no); ?>" onclick="SrNo(this.id)"><i class="fa fa-plus"></i></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\ProductPriceListMaster\mstfrm535edit.blade.php ENDPATH**/ ?>