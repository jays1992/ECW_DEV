...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Promo Master</a></div>
      ...
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="hidden"  name="PROMOID"     id="PROMOID"    value="<?php echo e(isset($HDR->PROMOID)?$HDR->PROMOID:''); ?>"      class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            <input <?php echo e($ActionStatus); ?> type="text"    name="PROMO_CODE"  id="PROMO_CODE" value="<?php echo e(isset($HDR->PROMOCODE)?$HDR->PROMOCODE:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>

          <div class="col-lg-2 pl"><p>Promo Date*</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="PROMO_DATE" id="PROMO_DATE" value="<?php echo e(isset($HDR->PROMODATE)?$HDR->PROMODATE:''); ?>"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="VALID_DATE" id="VALID_DATE" value="<?php echo e(isset($HDR->VALID_DATE)?$HDR->VALID_DATE:''); ?>" class="form-control" autocomplete="off" >
          </div>

          <div class="col-lg-2 pl"><p>Discount Percent</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="DIS_PER" id="DIS_PER" value="<?php echo e(isset($HDR->DIS_PERCENT)?$HDR->DIS_PERCENT:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>

          <div class="col-lg-2 pl"><p>Max Quanity</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="MAX_QTY" id="MAX_QTY" value="<?php echo e(isset($HDR->MAX_QTY)?$HDR->MAX_QTY:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" >                                                       
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\ECW\resources\views\masters\Sales\PromoMaster\mstfrm525view.blade.php ENDPATH**/ ?>