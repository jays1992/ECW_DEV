...
<form id="transaction_form" method="POST"  >
  <div class="container-fluid filter">    
    ...
    <div class="row">
          ...
          <div class="col-lg-1 pl"> <input type="radio" name="CUSTOMER_TYPE" value="EXIST" {{$ActionStatus}}  {{isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='EXIST'?'checked':''}} onchange="get_customer_type(this.value)" ></div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-1 pl"> <input type="radio" name="CUSTOMER_TYPE" {{$ActionStatus}} value="NEW" {{isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='NEW'?'checked':''}} onchange="get_customer_type(this.value)" ></div>
        </div>

        <div class="row">
          <div class="col-lg-2 pl"><p>Search</p></div>
          <div class="col-lg-2 pl"> 
            <input type="text" id="SEARCH_CUSTOMER" onkeyup="searchItem1(event)" {{$ActionStatus}} class="form-control" autocomplete="off" placeholder='Mobile No' onkeypress="return isNumberKey(event,this)" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl"> 
            <input type="text" name="MOBILE_NO" id="MOBILE_NO" {{$ActionStatus}} value="{{isset($HDR->MOBILE_NO)?$HDR->MOBILE_NO:''}}" class="form-control" autocomplete="off" placeholder='Mobile No' maxlength="12"  onkeypress="return isNumberKey(event,this)" >
          </div>
          ...
          <div id="Material" class="tab-pane fade in active">
              ...
              <thead id="thead1"  style="position: sticky;top: 0">
                ...
                @if(isset($MAT) && !empty($MAT))
                    ...
                    <td><input type="text" {{$ActionStatus}} style="width:130px;text-align:right;"   name="QTY[]" id="QTY_{{$key}}" value="{{isset($row->QTY)?$row->QTY:''}}" class="form-control three-digits"     onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" maxlength="13"  autocomplete="off"   /></td>

                    <td><input type="text" {{$ActionStatus}}  name="RATEPUOM[]" id="RATEPUOM_{{$key}}" value="{{isset($row->RATEPUOM)?$row->RATEPUOM:''}}" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'5')" /></td>

                    <td><input  type="text" {{$ActionStatus}} name="DISCPER[]" id="DISCPER_{{$key}}" value="{{isset($row->DISCPER)?$row->DISCPER:''}}" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>

                    <td><input  type="text" {{$ActionStatus}} name="DISCOUNT_AMT[]" id="DISCOUNT_AMT_{{$key}}" value="{{isset($row->DISCOUNT_AMT)?$row->DISCOUNT_AMT:''}}" class="form-control two-digits" maxlength="15"  autocomplete="off"  style="width:130px;text-align:right;" onkeyup="dataCalculation(this.id)" onfocusout="dataDec(this,'2')" /></td>
                ...
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    @foreach($PAYMENT as $key=>$row)
                          <tr  class="participantRow2">
                              ...
                              <td><input type="text" {{$ActionStatus}} name="PAID_AMT[]" id="PAID_AMT_0" value="{{isset($row->AMOUNT)?$row->AMOUNT:''}}" onkeyup="bindTotalValue()"  onfocusout="dataDec(this,'2')" class="form-control two-digits"  autocomplete="off"  /></td>
