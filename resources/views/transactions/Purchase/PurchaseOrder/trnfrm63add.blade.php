                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl"><p>Franchise*</p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="FR_popup" id="txtfr_popup" class="form-control mandatory" value="{{$objBRANCH->BRCODE.'-'.$objBRANCH->BRNAME}}" autocomplete="off" readonly/>
                            <input type="hidden" name="BRID_REF" id="BRID_REF" class="form-control" autocomplete="off"  value="{{$objBRANCH->BRID}}"/>
