                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl"><p>Franchise*</p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="FR_popup" {{$ActionStatus}}  id="txtfr_popup" class="form-control mandatory"  value={{$objPO->BRCODE.'-'.$objPO->BRNAME}} autocomplete="off" readonly/>
                            <input type="hidden" name="BRID_REF" id="BRID_REF" class="form-control" autocomplete="off"  value={{$objPO->BRID_REF}} />
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
      ...
      <table id="FRCodeTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tbody>
        @foreach ($Franchise as $index=>$Row)
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_BRID_REF[]" id="fridcode_{{ $index }}" class="clsfrid" value="{{ $Row-> BRID }}" ></td>
          <td class="ROW2">{{ $Row-> BRCODE }} <input type="hidden" id="txtfridcode_{{ $index }}" data-desc="{{ $Row-> BRCODE }}-{{ $Row-> BRNAME }}"  value="{{ $Row-> BRID }}"/></td>
          <td class="ROW3">{{ $Row-> BRNAME }}</td>
        </tr>
        @endforeach
        </tbody>
      </table>
