...
function validateForm(){
    ...
    /* else if(CYID_REF ===""){
        ...
        $("#alert").modal();
        $("#ProceedBtn").focus();
        $("#AlertMessage").text('Sorry! Franchise is not mapped with the user, Please contact administrator.');
        return false;
    }
    else{
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="card o-hidden border-0 shadow-lg">
                            ...
                            <div class="row">
                                  <div class="col-lg-12">
                                    <div class="p-5">
                                          ...
                                          <h3 class="form-title"><img class="imgyrls" src="{{ asset('img/white-logo1.png') }}"  /></h3>
                                                                              <div class="text-center"><h1 class="h4 text-gray-900 mt-4">Login Here!</h1></div>

                        <form method="POST" class="user formloginf"  id="loginForm" onsubmit="return validateForm()"  style="padding:60px 0px">
                        @csrf
                        <div class="form-group input-icons">
                        <!-- <i class="fa fa-user icon"></i>  -->
                        <input id="UCODE" type="text" class="form-control form-control-user control" name="UCODE" value="{{ old('UCODE') }}" autocomplete="off" placeholder="User ID" onfocusout="getCompany()" tabindex="1" >
                        ...
                        <input id="PASSWORD" type="PASSWORD" class="form-control form-control-user control @error('PASSWORD') is-invalid @enderror" onfocusout="getCompany()" name="PASSWORD" autocomplete="current-PASSWORD" placeholder="Password"  tabindex="2"  >

                        </div>
                        
                        <div class="form-group input-icons" hidden>
                        ...
                        <button type="submit" tabindex="6" class="btn btn-primary btn-user btn-block">Login <i class="fa fa-chevron-right"></i></button>
