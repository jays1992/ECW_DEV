  ...
  <div class="row">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="{{ asset('img/1slider.jpg') }}" alt="Express Car wash" style="width:100%;">
      </div>

      <div class="item">
        <img src="{{ asset('img/2slider.jpg') }}" alt="Express Car wash" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="{{ asset('img/3slider.jpg') }}" alt="Express Car wash" style="width:100%;">
      </div>
    </div>
