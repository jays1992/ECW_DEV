                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      <td><input type="checkbox" name="FRANCHISE_REF[]" value="{{$row->BRID}}" class="checkbox"></td>
                      <td><input type="text"     name="FRANCHISE_CODE[]" id="FRANCHISE_CODE_{{$key}}" value="{{$row->BRCODE}}" class="form-control showEmp" readonly  style="width:100%;"  /></td>
                      <td><input type="text"     id ="FRANCHISE_NAME_{{$key}}" value="{{$row->BRNAME}}" class="form-control w-100" maxlength="200" readonly style="width:100%;" ></td>
                    </tr>
