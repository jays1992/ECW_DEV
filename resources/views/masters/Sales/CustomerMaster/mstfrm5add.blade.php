...
<div class="container-fluid filter">
    ...
    <div class="row"> 
      ...
      <div class="col-lg-1 pl"><p>Date of Birth</p></div>
			<div class="col-lg-2 pl">
				<input type="date" name="DOB" id="DOB" class="form-control mandatory">   
			</div>

      <div class="col-lg-1 pl"><p>Date of Marriage Anniversary</p></div>
			<div class="col-lg-2 pl">
				<input type="date" name="DOA" id="DOA" class="form-control mandatory">   
			</div>
