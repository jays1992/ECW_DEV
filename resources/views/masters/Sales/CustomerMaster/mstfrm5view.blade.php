...
<div class="container-fluid filter">
   ...
   <div class="col-lg-2 pl"><p>Date of Birth</p></div>
			<div class="col-lg-2 pl">
				<input type="date" name="DOB" disabled id="DOB" value="{{ $objMstCust->DOB }}" class="form-control mandatory">   
			</div>

      <div class="col-lg-2 pl"><p>Date of Marriage Anniversary</p></div>
			<div class="col-lg-2 pl">
				<input type="date" name="DOA" id="DOA"  disabled value="{{ $objMstCust->DOA }}" class="form-control mandatory">   
			</div>
      </div>
