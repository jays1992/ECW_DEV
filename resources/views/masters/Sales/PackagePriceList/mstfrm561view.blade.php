...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Package Price List</a></div>
    ...
    <div class="container-fluid filter">
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DOC_DT" id="DOC_DATE" value="{{isset($HDR->DOC_DT)?$HDR->DOC_DT:''}}"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
          </div>

          <div class="col-lg-2 pl"><p>Price Level*</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text"   name="PRICE_LEVEL" id="PRICE_LEVEL" onclick="getPriceLevel()" value="{{isset($HDR->PLCODE)?$HDR->PLCODE:''}}-{{isset($HDR->PLNAME)?$HDR->PLNAME:''}}"  class="form-control"  autocomplete="off"  readonly/>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td><input {{$ActionStatus}} type="text" name="PACKAGE_CODE[]" id="PACKAGE_CODE_{{$key}}"         value="{{isset($row->PKMCODE)?$row->PKMCODE:''}}"   class="form-control"  autocomplete="off" onclick="getProduct(this.id)"  readonly/></td>
                      <td hidden><input type="text" name="PACKAGE_REF[]" id="PACKAGE_REF_{{$key}}"          value="{{isset($row->PKMID)?$row->PKMID:''}}"   class="form-control"  autocomplete="off" /></td>
                      <td><input {{$ActionStatus}} type="text" name="PACKAGE_NAME[]" id="PACKAGE_NAME_{{$key}}"         value="{{isset($row->PKMNAME)?$row->PKMNAME:''}}"   class="form-control"  autocomplete="off"  readonly/></td>
                      
                      <td><input {{$ActionStatus}} type="text" name="PRICE[]"  id="PRICE_{{$key}}"    value="{{isset($row->PRICE)?$row->PRICE:''}}"    onkeypress="return onlyNumberKey(event)" class="form-control"  autocomplete="off"  /></td>
                      <td align="center">
