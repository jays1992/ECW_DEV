    ...
    <div class="container-fluid filter">
      <div class="inner-form">         
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="date" name="DOC_DT" id="DOC_DATE" value="{{date('Y-m-d')}}"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy">
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td><input type="text" name="PACKAGE_CODE[]" id="PACKAGE_CODE_{{$key}}"               value="{{isset($row->PKMCODE)?$row->PKMCODE:''}}"   class="form-control"  autocomplete="off" onclick="getPackage(this.id)"  readonly/></td>
                      <td hidden><input type="text" name="PACKAGE_REF[]" id="PACKAGE_REF_{{$key}}"          value="{{isset($row->PACKAGE_REF)?$row->PACKAGE_REF:''}}"   class="form-control"  autocomplete="off" /></td>
                      <td><input type="text" name="PACKAGE_NAME[]" id="PACKAGE_NAME_{{$key}}"       value="{{isset($row->PKMNAME)?$row->PKMNAME:''}}"   class="form-control"  autocomplete="off"  readonly/></td>
                      
                      <td><input type="text" name="PRICE[]"  id="PRICE_{{$key}}"                     value="{{isset($row->PRICE)?$row->PRICE:''}}"    onkeypress="return isNumberDecimalKey(event,this)" class="form-control"  autocomplete="off"  /></td>
                      <td align="center">
...
$.ajax({
  url:'{{route("master",[$FormId,"getPackage"])}}',
  type:'POST',
  success:function(data) {
    var html = '';
