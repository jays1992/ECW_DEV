...
<div class="container-fluid purchase-order-view filter">     
  ...
  <div class="inner-form">
      ...
      <div class="row">    
        ...
        <div class="col-lg-2 pl">
        <input type="file" name="UPLOADBANNER" id="UPLOADBANNER" value="{{isset($objResponse->UPLOADBANNER) && $objResponse->UPLOADBANNER !=''?$objResponse->UPLOADBANNER:''}}" class="form-control"/>
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                  <td><input disabled type="checkbox" name="FRANCHISEE_REF[{{$key}}]" {{$row->BRID ==$row->FRANCHISEE_REF?'checked':''}} value="{{$row->BRID}}" class="checkbox" ></td>
                  <td><input disabled type="text" name="FRANCHISEE_CODE_{{$key}}" id="FRANCHISEE_CODE_{{$key}}" value="{{$row->BRCODE}}" class="form-control showEmp" readonly  style="width:100%;"  /></td>
                  <td><input  disabled type="text" id ="FRANCHISEE_NAME_{{$key}}"  id ="FRANCHISEE_NAME_{{$key}}" value="{{$row->BRNAME}}" class="form-control w-100" maxlength="200" readonly style="width:100%;" ></td>
