                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr class="participantRow">
                      ...
                      <td hidden><input {{$ActionStatus}} type="text" name="BALANCE_AMT[]" id="BALANCE_AMT_{{$key}}" value="{{isset($row->BALANCE_AMT)?floatval($row->BALANCE_AMT):''}}"     class="form-control"  autocomplete="off"  readonly/></td>
                      <td hidden><input {{$ActionStatus}} type="text" name="NET_AMOUNT[]"  id="NET_AMOUNT_{{$key}}" value="{{isset($row->NET_AMOUNT)?$row->NET_AMOUNT:''}}"  class="form-control"  autocomplete="off"  readonly/></td>
