...
<div class="container-fluid filter">
	<form id="add_form_data" method="POST"  > 
		...
		<div class="inner-form">
          ...
          <input type="text" name="VCODE" id="VCODE" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
