         ...
         <form id="frm_mst_edit" method="POST"  > 
          ...
          <div class="inner-form">
            ...
            <div class="row" >
              ...
              <div class="col-lg-2 pl">
                <input type="text"   name="BRANCH_NAME" id="BRANCH_NAME" value="{{isset($HDR[0]->BRANCH_NAME)?$HDR[0]->BRANCH_NAME:''}}"  class="form-control"  autocomplete="off"  onclick="getBranchMaster()" readonly required/>
                <input type="hidden" name="BRANCH_ID" id="BRANCH_ID" value="{{isset($HDR[0]->BRANCH_ID)?$HDR[0]->BRANCH_ID:''}}"     class="form-control"  autocomplete="off" />  
              </div>
...
function getBranchMaster(){
  ...
  $.ajax({
    url:'{{route("master",[145,"getBranchMaster"])}}',
    type:'POST',
    success:function(data) {
      var html = '';
