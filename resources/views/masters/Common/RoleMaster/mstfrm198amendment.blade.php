...
<form id="frm_trn_se" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >
  ...
  <div class="inner-form">
    ...
    <div class="row">
        ...
        <input type="text" name="RCODE" id="RCODE"  class="form-control mandatory" value="{{isset($objSE->RCODE)?$objSE->RCODE:''}}"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
   		</div>
			
			<div class="col-lg-1 pl col-md-offset-1"><p>Description</p></div>
			<div class="col-lg-2 pl pr">
        <input type="text" name="DESCRIPTIONS" id="DESCRIPTIONS" value="{{isset($objSE->DESCRIPTIONS)?$objSE->DESCRIPTIONS:''}}" class="form-control" autocomplete="off" />
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="date" name="AMENDMENT_DATE" id="AMENDMENT_DATE" value="{{isset($objSE->AMENDMENT_DATE)?$objSE->AMENDMENT_DATE:''}}"  class="form-control mandatory" autocomplete="off">
   	  </div>

      <div class="col-lg-1 pl"><p>Amendment Reason</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="AMENDMENT_REASON" id="AMENDMENT_REASON" value="{{isset($objSE->AMENDMENT_REASON)?$objSE->AMENDMENT_REASON:''}}"  class="form-control mandatory" autocomplete="off">
   	  </div>
	  </div>
    ...
    <div class="row" style="margin-left: 1px;">
      ...
      <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{isset($objSE->DEACTIVATED) && $objSE->DEACTIVATED == 1 ? "checked" : ""}}
        value='{{isset($objSE->DEACTIVATED) && $objSE->DEACTIVATED == 1 ? 1 : 0}}' tabindex="2"  >
      </div>
      
      <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
      <div class="col-lg-2 pl">
        <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" {{isset($objSE->DEACTIVATED) && $objSE->DEACTIVATED == 1 ? "" : "disabled"}} value="{{isset($objSE->DODEACTIVATED) && $objSE->DODEACTIVATED !="" && $objSE->DODEACTIVATED !="1900-01-01" ? $objSE->DODEACTIVATED:''}}" tabindex="3" placeholder="dd/mm/yyyy"  />
      </div>
    </div>
