...
<div class="col-lg-2 pl"><p> Compnay Owned Franchise</p></div>
        ...
        <input type="checkbox" disabled name="OWNED_FRANCHISE" id="OWNED_FRANCHISE" {{isset($objResponse->OWNED) && $objResponse->OWNED==1? 'checked':''}} class="form-checkbox" tabindex="33" >
...
<div class="row">
  ...
  <div class="col-lg-2 pl">
    <label>{{isset($HDR->PLCODE)?$HDR->PLCODE:''}}{{isset($HDR->PLNAME) && $HDR->PLNAME !=''?'-'.$HDR->PLNAME:''}}</label>
  </div>

  <div class="col-lg-1 pl"><p>Franchisee label</p></div>
  <div class="col-lg-2 pl">
    <label>{{isset($HDR->FRANCHISEE_LABEL)?$HDR->FRANCHISEE_LABEL:''}}</label>
  </div>
</div>
