...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[147,'index'])}}" class="btn singlebt">Franchise Master</a>
                </div><!--col-2-->
    ...
    <div class="col-lg-1 pl"><p>Designation</p></div>
      ...
      <div class="col-lg-2 pl"><p> Compnay Owned Franchise</p></div>
        ...
        <input type="checkbox" name="OWNED_FRANCHISE" id="OWNED_FRANCHISE" {{isset($objResponse->OWNED) && $objResponse->OWNED==1? 'checked':''}} class="form-checkbox" tabindex="33" >
  ...
  <div class="col-lg-1 pl"><p>Price Level*</p></div>
    <div class="col-lg-2 pl">
      <input type="text"   name="PRICE_LEVEL" id="PRICE_LEVEL" onclick="getPriceLevel()" value="{{isset($HDR->PLCODE)?$HDR->PLCODE:''}}{{isset($HDR->PLNAME) && $HDR->PLNAME !=''?'-'.$HDR->PLNAME:''}}"  class="form-control"  autocomplete="off"  readonly/>
    ...
    <div class="col-lg-1 pl"><p>Franchisee label*</p></div>
      <div class="col-lg-2 pl">
        <select name="FRANCHISEE_LABEL" id="FRANCHISEE_LABEL" class="form-control mandatory" tabindex="30" >
          <option {{isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Other'?'selected="selected"':'' }} value="Other">Other</option>
          <option {{isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Platinum'?'selected="selected"':'' }} value="Platinum">Platinum</option>
          <option {{isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Gold'?'selected="selected"':'' }} value="Gold">Gold</option>
          <option {{isset($objResponse->FRANCHISEE_LABEL) && $objResponse->FRANCHISEE_LABEL == 'Silver'?'selected="selected"':'' }} value="Silver">Silver</option>
				</select>
