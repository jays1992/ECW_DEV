...
use Chartblocks;
use App\Exports\AppointmentBookingRpt;
use Maatwebsite\Excel\Facades\Excel;

class RptFrm559Controller extends Controller
{
    protected $form_id = 559;
    protected $vtid_ref   = 629;  //voucher type id
    protected $view     = "reports.sales.AppointmentBookingRpt.rptfrm";
    // //validation messages  
    // 
    /**
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Appointment_Booking_Report');
