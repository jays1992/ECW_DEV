...
class MstFrm204Controller extends Controller{
    ...
    public function GetUserDetails(Request $request) { 
        ...
        $UserCheck  =   DB::select("SELECT COUNT(MAPBRID_REF) AS RECORD FROM TBL_MST_USER_BRANCH_MAP WHERE CYID_REF=$CYID_REF AND USERID_REF=$USERID ");
        echo $UserCheck[0]->RECORD;       
    }
