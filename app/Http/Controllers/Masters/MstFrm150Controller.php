...
class MstFrm150Controller extends Controller
{
    ...
    public function index(){
        ...
        $objDataList=DB::select("SELECT DISTINCT T1.USERID,T1.UCODE,T1.DESCRIPTIONS,T1.DEACTIVATED,T1.DODEACTIVATED,T1.INDATE,T1.STATUS 
    ...
    public function getEmployee(){
        ...
        WHERE T1.CYID_REF='$CYID_REF'  AND T1.STATUS='A'  AND (T2.DEACTIVATED=0 or T2.DEACTIVATED is null)");
