...
class MstFrm535Controller extends Controller{
    ...
    public function add(){
        ...
        $objData    =   DB::select("SELECT 
                        ...
                        T2.PRICE_LEVEL_REF  
                        FROM TBL_MST_PPLM T1
                        LEFT JOIN TBL_MST_BRANCH T2 ON T2.PRICE_LEVEL_REF=T1.PPLM_ID ");
    ...
    public function edit($id=NULL){
        ...
        if(!is_null($id)){
            ...
            $HDR            =   DB::select("SELECT T1.*,T2.PLID,T2.PLCODE,T2.PLNAME FROM TBL_MST_PPLM T1 LEFT JOIN TBL_MST_PRICE_LEVEL T2 ON T2.PLID=T1.PLID_REF WHERE T1.PPLM_ID='$id'"); 
