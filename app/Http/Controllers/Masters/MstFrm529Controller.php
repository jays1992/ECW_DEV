...
class MstFrm529Controller extends Controller{
    ...
    public function save(Request $request){
        ...
        $CARD_VALIDITY_MODE =   $request['CARD_VALIDITY_MODE'];
        ...
        $log_data = [
            ...
            $ACTIONNAME,$IPADDRESS,$CARD_VALIDITY_MODE
        ];
    ...
    public function update(Request $request){
        ...
        $log_data = [
            ...
            $USERID_REF,Date('Y-m-d'),Date('h:i:s.u'),$ACTIONNAME,$IPADDRESS,$CARD_VALIDITY_MODE
        ];
