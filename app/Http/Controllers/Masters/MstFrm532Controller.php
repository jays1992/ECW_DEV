...
class MstFrm532Controller extends Controller{
    ...
    public function getCardMaster(Request $request){
        ...
        T3.CURRENT_BALANCE AS AMOUNT,
        T2.AMOUNT_ID,
        T2.NET_AMOUNT,
        T2.VALIDITY_MON
        FROM TBL_MST_V_MASTER T1
        INNER JOIN TBL_MST_V_MASTER_DETAILS T2 ON T2.DOC_ID_REF=T1.DOC_ID
        LEFT JOIN TBL_TRN_VALUECARD_SALE_HDR T3 ON T2.DETAIL_ID=T3.CARDID_REF AND T3.BRID_REF=T1.FRANCHISE_ID
    ...
    public function ViewReport($request) {
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Value_Card ADD_Value_Receipt_Print');
