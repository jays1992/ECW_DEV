...
class TrnFrm543Controller extends Controller{
    ...
    public function searchCustomer(Request $request){
        ...
        WHERE  T1.CYID_REF='$CYID_REF' AND T1.TYPE='CUSTOMER' AND T1.MONO='$SEARCH_ITEM' AND T1.STATUS='A' AND (T1.DEACTIVATED=0 OR T1.DEACTIVATED IS NULL)
        "); 
    ...
    public function loadTax(){
        ...
        $WHERE_STATE    =   $CUSTOMER_STATE->REGSTID_REF === $BRANCH_STATE->STID_REF?" T1.WITHINSTATE='1'":" T1.OUTOFSTATE='1'";
