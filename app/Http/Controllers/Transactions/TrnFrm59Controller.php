...
class TrnFrm59Controller extends Controller
{
    ...
    return view($this->view.'add', compact(['AlpsStatus','FormId','objStore','objlastPIDT','objCOMPANY','TabSetting','doc_req','docarray','Franchise','objBRANCH']));       
   }
   ...
   public function save(Request $request) {
    ...
    public function edit($id=NULL){
        ...
        $objMstResponse = DB::table('TBL_TRN_PRIN02_HDR')
                ->where('TBL_TRN_PRIN02_HDR.FYID_REF','=',Session::get('FYID_REF'))
                ->where('TBL_TRN_PRIN02_HDR.CYID_REF','=',Auth::user()->CYID_REF)
                ->where('TBL_TRN_PRIN02_HDR.BRID_REF','=',Session::get('BRID_REF'))
                ->where('TBL_TRN_PRIN02_HDR.PIID','=',$id)
                ->leftJoin('TBL_MST_BRANCH', 'TBL_MST_BRANCH.BRID', '=', 'TBL_TRN_PRIN02_HDR.BRID_REF')
                ->select('TBL_TRN_PRIN02_HDR.*','TBL_MST_BRANCH.BRCODE','TBL_MST_BRANCH.BRNAME')
                ->first();
        ...
        return view($this->view.'edit', compact(['AlpsStatus','FormId','objRights','user_approval_level','objMstResponse',
                'objstorecode2','objStore','objlastPIDT','ObjItem2','objList1Count','objdeptcode2','objCOMPANY','ActionStatus','TabSetting','Franchise'])); 
