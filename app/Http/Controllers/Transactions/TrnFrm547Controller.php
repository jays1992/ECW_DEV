...
class TrnFrm547Controller extends Controller
{
    ...
    public function index(){    
        ...
        $objDataList	=	DB::select("select hdr.POID,hdr.PO_NO,hdr.PO_DT,hdr.PO_VRF,hdr.PO_VTO,hdr.INDATE,
                            ...
                            where a.VTID_REF = 63
                            and hdr.CYID_REF='$CYID_REF' AND hdr.VID_REF=2305
        ...
        return view('transactions.Purchase.POFRANCHISE.trnfrm547',compact(['REQUEST_DATA','objRights','objDataList']));        
    }
    ...
    public function add(){    
        ...
        return view('transactions.Purchase.POFRANCHISE.trnfrm547add',compact([
...
public function getItemDetailswithoutQuotation(Request $request){
   ...
   public function attachment($id){
    ...
    if(!is_null($id))
    {
        ...
        $objMstVoucherType = DB::table("TBL_MST_VOUCHERTYPE")
            ...
            return view('transactions.Purchase.POFRANCHISE.trnfrm547attachment',compact(['objSalesorder','objMstVoucherType','objAttachments']));
    }
   ...
   public function save(Request $request) {
    ...
    public function edit($id=NULL){
        ...
        return view('transactions.Purchase.POFRANCHISE.trnfrm547edit',compact(['AlpsStatus','objPO','objRights','objCount1',
    ...
    public function view($id=NULL){
        ...
        return view('transactions.Purchase.POFRANCHISE.trnfrm547view',compact(['AlpsStatus','objPO','objRights','objCount1',
           'objCount2','objCount3','objCount4','objCount5','objPOMAT','objPOCAL','objPOTNC','objPOUDF','objPOPSLB',
           'objdeptcode','objCalculationHeader','objUdfPOData','objTNCHeader','objdeptcode2','ObjPIVQData','objvendorcode',
           'objShpAddress','objBillAddress','objItems','objUOM','objItemUOMConv','objTNCDetails','objUdfPOData2',
           'objCalHeader','objCalDetails','TAXSTATE','POBASEDON','objCOMPANY','objCountAttachment','ActionStatus',
   ...
   public function docuploads(Request $request){
    ...
    if(empty($uploaded_data)){
        return redirect()->route("transaction",[547,"attachment",$ATTACH_DOCNO])->with("success","Already exists. No file uploaded");
    }
   ...
   try {
       ...
       return redirect()->route("transaction",[547,"attachment",$ATTACH_DOCNO])->with("error","There is some error. Please try after sometime");
    ...
    if($sp_result[0]->RESULT=="SUCCESS"){
        ...
        return redirect()->route("transaction",[547,"attachment",$ATTACH_DOCNO])->with("success","Files successfully attached. ".$duplicate_files.$invlid_files);


    }        elseif($sp_result[0]->RESULT=="Duplicate file for same records"){
   
        return redirect()->route("transaction",[547,"attachment",$ATTACH_DOCNO])->with("success","Duplicate file name. ".$invlid_files);

    }else{

        return redirect()->route("transaction",[547,"attachment",$ATTACH_DOCNO])->with($sp_result[0]->RESULT);
    }
    ...
    public function amendment($id=NULL){
        ...
        return view('transactions.Purchase.POFRANCHISE.trnfrm547amendment',compact(['AlpsStatus','objPO','objRights','objCount1',
           'objCount2','objCount3','objCount4','objCount5','objPOMAT','objPOCAL','objPOTNC','objPOUDF','objPOPSLB',
           'objdeptcode','objCalculationHeader','objUdfPOData','objTNCHeader','objdeptcode2', 'ObjPIVQData','objvendorcode',
           'objShpAddress','objBillAddress','objItems','objUOM','objItemUOMConv','objTNCDetails','objUdfPOData2',
